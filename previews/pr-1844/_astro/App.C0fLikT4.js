import"./disclose-version.DsnmJJEf.js";import"./legacy.BGYm4LQg.js";import{p as he,f as T,g as l,n as ie,s as R,a as ue,P as Ce,u as le,L as me,d as re,b7 as be,b as ae,c as Se,r as we}from"./runtime.BBxoejyG.js";import{c as I,f as k,a as x}from"./template.Bs5bR2Nc.js";import{C as Pe}from"./Canvas.BXbx6C4n.js";import{aF as N,bs as q,V as M,at as j,aX as Y,aG as Re,eE as Ae,fG as ye,aa as Ee,dQ as De,bD as Fe,bB as Be,bE as Ue,bF as Ie,bA as Ne,bC as ze,eR as Oe,C as z,i as F,bz as ke,A as Le,ah as C,cm as Ge,cQ as Qe,cl as $e,c_ as Ve,_ as He,z as We,ge as Xe,bq as je,J as Ye,a_ as Ke}from"./observe.svelte.CFYFNOc8.js";import{e as qe}from"./events.C6-11v6q.js";import{c as b}from"./svelte-component.BCRxooPF.js";import{s as ge,a as Ze}from"./store.5lYVrety.js";/* empty css                                                      */import{u as ve}from"./useThrelte.o9barqGH.js";import{u as xe}from"./useTask.svelte.B27ZeBux.js";import{i as Me}from"./raycast.B9A6jkWT.js";import{O as Je}from"./OrbitControls.BezX-0tL.js";import{s as oe}from"./snippet.DUyBEcRR.js";import{a as ne}from"./await.BJOnrYV7.js";import{p as et,s as tt,r as st}from"./props.CGk66viq.js";import{u as it}from"./useGltf.N8ph0GFD.js";import{u as rt}from"./useDraco.BF2kS1wh.js";import{e as at}from"./each.BT71SVHo.js";import{I as ot,a as lt}from"./Instance.TkeYUB8E.js";import{P as L,F as fe}from"./Pass.CdU30v92.js";/* empty css                                                   */import"./if.UXK_Jlz6.js";import"./branches.Bg9W3cxg.js";import"./this.q4pHlqVj.js";import"./Context.lmo6U6Sz.js";import"./create-subscriber.CDornkmJ.js";import"./index.DMCjpMEg.js";import"./index-client.Cy63zNyZ.js";import"./useStage.DT-BgVhI.js";import"./injectPlugin.D3y05FLP.js";import"./transitions.Bdo3_t96.js";import"./loop.BGGTUj09.js";import"./render.D4buDWGY.js";import"./OrbitControls.CPMLV8H2.js";import"./useControlsContext.BNHFb7l2.js";import"./GLTFLoader.AxzGpG1v.js";import"./BufferGeometryUtils.xrzs_Nyi.js";const K={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}O.BlurDirectionX=new M(1,0);O.BlurDirectionY=new M(0,1);var dt=k("<!> <!>",1),mt=k("<!> <!> <!>",1),gt=k("<!> <!>",1);function vt(g,e){he(e,!0);let t=et(e,"ref",15),i=st(e,["$$slots","$$events","$$legacy","fallback","error","children","ref"]);const o=rt(),s=it("/spaceship-tutorial/models/spaceship-transformed.glb",{dracoLoader:o}),a=Me("/spaceship-tutorial/textures/energy-beam-opacity.png");function u(r){r.transparent=!0,r.alphaToCoverage=!0,r.depthFunc=Ve,r.depthTest=!0,r.depthWrite=!0}s.then(r=>{u(r.materials.spaceship_racer),u(r.materials.cockpit)});var n=I(),A=T(n);b(A,()=>C.Group,(r,f)=>{f(r,tt({dispose:!1},()=>i,{threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:0},get ref(){return t()},set ref(c){t(c)},children:(c,Z)=>{var S=gt(),_=T(S);ne(_,()=>s,v=>{var h=I(),p=T(h);oe(p,()=>e.fallback??ie),x(v,h)},(v,h)=>{var p=I(),P=T(p);b(P,()=>C.Group,(B,G)=>{G(B,{scale:.003,rotation:[0,-Math.PI*.5,0],position:[.95,0,0],threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:1},children:(Q,pe)=>{var $=mt(),U=T($);b(U,()=>C.Mesh,(y,E)=>{E(y,{castShadow:!0,receiveShadow:!0,get geometry(){return l(h).nodes.Cube001_spaceship_racer_0.geometry},get material(){return l(h).materials.spaceship_racer},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:2}})});var H=R(U,2);b(H,()=>C.Mesh,(y,E)=>{E(y,{castShadow:!0,receiveShadow:!0,get geometry(){return l(h).nodes.Cube005_cockpit_0.geometry},get material(){return l(h).materials.cockpit},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:3}})});var W=R(H,2);ne(W,()=>a,null,(y,E)=>{var V=I(),J=T(V);b(J,()=>C.Mesh,(d,m)=>{m(d,{position:[0,0,-1350],"rotation.x":Math.PI*.5,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:4},children:(D,ee)=>{var ce=dt(),de=T(ce);b(de,()=>C.CylinderGeometry,(te,se)=>{se(te,{args:[70,25,1600,15],threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:5}})});var Te=R(de,2);b(Te,()=>C.MeshBasicMaterial,(te,se)=>{se(te,{color:[1,.4,.02],get alphaMap(){return l(E)},transparent:!0,get blending(){return $e},get blendDst(){return Qe},get blendEquation(){return Ge},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:6}})}),x(D,ce)},$$slots:{default:!0}})}),x(y,V)}),x(Q,$)},$$slots:{default:!0}})}),x(v,p)},(v,h)=>{var p=I(),P=T(p);oe(P,()=>e.error??ie,()=>({error:l(h)})),x(v,p)});var w=R(_,2);oe(w,()=>e.children??ie,()=>({ref:t()})),x(c,S)},$$slots:{default:!0}}))}),x(g,n),ue()}var _t=k("<!> <!> <!>",1);function xt(g,e){he(e,!0);let t=350,i=["#fcaa67","#C75D59","#ffffc7","#8CC5C6","#A5898C"],o=Ce([]);const s=Me("/spaceship-tutorial/textures/star.png");function a(r,f){let c=Math.random()*(f-r);return r+c}function u(r){a(0,1)>.8?(r.position=[a(-10,-30),a(-5,5),a(6,-6)],r.length=a(1.5,15)):(r.position=[a(-15,-45),a(-10.5,1.5),a(30,-45)],r.length=a(2.5,20)),r.speed=a(19.5,42),r.color.set(i[Math.floor(Math.random()*i.length)]??"white").convertSRGBToLinear().multiplyScalar(1.3)}for(let r=0;r<t;r++){const f={id:He.generateUUID(),position:[0,0,0],length:0,speed:0,color:new z};u(f),o.push(f)}xe(r=>{for(const f of o)f.position[0]+=f.speed*r,f.position[0]>40&&u(f)});var n=I(),A=T(n);ne(A,()=>s,null,(r,f)=>{ot(r,{limit:t,range:t,children:(c,Z)=>{var S=_t(),_=T(S);b(_,()=>C.PlaneGeometry,(h,p)=>{p(h,{args:[1,.05],threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Stars.svelte",index:0}})});var w=R(_,2);b(w,()=>C.MeshBasicMaterial,(h,p)=>{p(h,{get side(){return We},get alphaMap(){return l(f)},transparent:!0,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Stars.svelte",index:1}})});var v=R(w,2);at(v,17,()=>o,({id:h,position:p,length:P,color:B})=>h,(h,p)=>{let P=()=>l(p).position,B=()=>l(p).length,G=()=>l(p).color;{let Q=le(()=>[B(),1,1]);lt(h,{get position(){return P()},get scale(){return l(Q)},get color(){return G()}})}}),x(c,S)},$$slots:{default:!0}})}),x(g,n),ue()}var Mt=k("<!> <!> <!> <!>",1);function Tt(g,e){he(e,!0);const t=()=>ge(n,"$camera",o),i=()=>ge(u,"$size",o),[o,s]=Ze(),{scene:a,size:u,camera:n,renderer:A}=ve();let r,f=0,c=0,Z=new Xe(A),S,_=re(void 0),w=re(0),v=re(0);const h=new ut(A),p=new pt(a,t()),P=new O(new M(i().width,i().height),.275,1,0),B=new ft;h.addPass(p),h.addPass(P),h.addPass(B),me(()=>{h.setSize(i().width,i().height),P.resolution.set(i().width,i().height)}),me(()=>{p.camera=t()});const{renderStage:G}=ve();xe(()=>{if(r){const d=r?.y||0;f+=(d-l(w))*.002,f*=.95,ae(w,l(w)+f);const D=r.clone().sub(new F(0,l(w),0)).normalize().dot(new F(0,1,0)),ee=Math.acos(D)-Math.PI*.5;c+=(ee-l(v))*.01,c*=.85,ae(v,l(v)+c)}S&&S.dispose(),l(_)&&(l(_).visible=!1,a.background=null,S=Z.fromScene(a,0,.1,1e3),a.background=new z("#598889").multiplyScalar(.05),l(_).visible=!0,l(_).traverse(d=>{if("material"in d){const m=d.material;"envMapIntensity"in m&&(m.envMap=S.texture,m.envMapIntensity=100,m.normalScale.set(.3,.3))}})),h.render()},{stage:G});const Q=new je(20,20),pe=new Ye(Q),$=new Ke,U=new M;function H(d){U.x=d.clientX/window.innerWidth*2-1,U.y=-(d.clientY/window.innerHeight)*2+1,$.setFromCamera(U,t()),r=$.intersectObject(pe)[0]?.point,r&&(r.x=3)}var W=Mt();qe("pointermove",be,H);var y=T(W);b(y,()=>C.PerspectiveCamera,(d,m)=>{m(d,{makeDefault:!0,position:[-10,6,15],fov:25,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Scene.svelte",index:0},children:(D,ee)=>{Je(D,{enableDamping:!0,enableZoom:!1,target:[0,0,0]})},$$slots:{default:!0}})});var E=R(y,2);b(E,()=>C.DirectionalLight,(d,m)=>{m(d,{intensity:1.8,position:[0,10,0],castShadow:!0,"shadow.bias":-1e-4,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Scene.svelte",index:1}})});var V=R(E,2);{let d=le(()=>[0,l(w),0]),m=le(()=>[l(v),0,l(v),"ZXY"]);vt(V,{get position(){return l(d)},get rotation(){return l(m)},get ref(){return l(_)},set ref(D){ae(_,D,!0)}})}var J=R(V,2);xt(J,{}),x(g,W),ue(),s()}var Ct=k('<div class="svelte-1tcrzz0"><!></div>');function ns(g){var e=Ct(),t=Se(e);Pe(t,{autoRender:!1,children:(i,o)=>{Tt(i,{})},$$slots:{default:!0}}),we(e),x(g,e)}export{ns as default};
