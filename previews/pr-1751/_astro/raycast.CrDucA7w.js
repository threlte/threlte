import"./disclose-version.DsnmJJEf.js";import{fY as vs,aM as yt,en as Ce,c as mn,v as ws,h as B,a as kr,aP as Hi,i as Pt,e as re,g as k,as as wi,Z as Bt,$ as X,bs as $r,b5 as bs,b2 as Nt,O as Me,u as _s,T as Tt,j as q,B as Y,g6 as rn,fV as bi,g5 as xe,V as zt,eQ as mt,aE as Ss,a7 as Hr,a5 as Ts,f as Ms,d as As,C as _i,an as Zn,R as Ae,q as Xn,fv as Si,S as Ti,M as Ht,aG as jr,c2 as Ps,x as K,aH as Wr,eG as Ds,ba as Yn,ad as te,fR as Bs,a6 as zs,e4 as Es,Q as _n,a4 as ve,aj as Kn,b1 as at,at as Gr,fI as Qt,D as Cs,aJ as qr,W as Is,dV as sn,o as ji,bX as Us,eE as Fs,ae as Rs,N as pt,I as Os,t as Ls,di as Mi,bE as un,aX as Pe,J as fn,av as Ns,eZ as Vs,aL as ks,b as $s,a3 as Hs}from"./T.CIQBugds.js";/* empty css                                                      */import{_ as Zr,aD as js,aE as Ws,p as Ai,g as st,$ as Wi,f as we,a as Pi,n as Di,s as Sn,h as Gs,e as qs,a8 as Zs}from"./runtime.XdAhm9hg.js";import{c as Bi,a as be,f as Xr}from"./template.D6i0fWOI.js";import{s as zi}from"./snippet.zb5DD4fg.js";import{i as Gi}from"./if.B_4c_Y5G.js";import{c as Tn}from"./svelte-component.C2lNx87h.js";import{p as Mt,s as Yr,r as Kr}from"./props.29maieIx.js";import{a as qi,s as Xs}from"./store.PBLySVcD.js";import{w as dn,d as Jn,r as Ys}from"./index.DNbPeuyJ.js";import{a as Ks}from"./index-client.C7k-19DO.js";import{u as Js}from"./useStage.CgYX7zAO.js";import{i as Jr}from"./injectPlugin.BUbDuExm.js";import{t as Qs}from"./transitions.DqydtAYe.js";const on=n=>{const t=dn(void 0),e=dn(void 0);return n.then(i=>{t.set(i)}).catch(i=>{console.error("Error in asyncWritable:",i.message),e.set(i)}),Object.assign(Object.assign(n,t),{error:e,promise:n})};function to(n,t){const{remember:e,clear:i}=vs();let r;const o=()=>{const a=new n(...t?.args??[]);return t?.extend?.(a),a};return{load:(a,u)=>{const f=async h=>{if(r||(r=o()),"loadAsync"in r){const l=await r.loadAsync(h,u?.onProgress);return u?.transform?.(l)??l}else return new Promise((l,d)=>{r.load(h,m=>l(u?.transform?.(m)??m),m=>u?.onProgress?.(m),d)})};if(Array.isArray(a)){const h=a.map(d=>e(()=>f(d),[n,d]));return on(Promise.all(h))}else if(typeof a=="string"){const h=e(()=>f(a),[n,a]);return on(h)}else{const h=Object.values(a).map(d=>e(()=>f(d),[n,d]));return on(Promise.all(h).then(d=>Object.fromEntries(Object.entries(a).map(([m],x)=>[m,d[x]]))))}},clear:a=>{Array.isArray(a)?a.forEach(u=>{i([n,u])}):typeof a=="string"?i([n,a]):Object.entries(a).forEach(([u,f])=>{i([n,u,f])})},loader:r}}const Ct=n=>({subscribe:n.subscribe,get current(){return n.current}});let _e=0;const Ei=yt(!1),yn=yt(!1),Ci=yt(void 0),Ii=yt(0),Ui=yt(0),Qr=yt([]),Fi=yt(0),{onStart:eo,onLoad:no,onError:io}=Ce;Ce.onStart=(n,t,e)=>{eo?.(n,t,e),yn.set(!0),Ci.set(n),Ii.set(t),Ui.set(e);const i=(t-_e)/(e-_e);Fi.set(i),i===1&&Ei.set(!0)};Ce.onLoad=()=>{no?.(),yn.set(!1)};Ce.onError=n=>{io?.(n),Qr.update(t=>[...t,n])};Ce.onProgress=(n,t,e)=>{t===e&&(_e=e),yn.set(!0),Ci.set(n),Ii.set(t),Ui.set(e);const i=(t-_e)/(e-_e)||1;Fi.set(i),i===1&&Ei.set(!0)};const ro={active:Ct(yn),item:Ct(Ci),loaded:Ct(Ii),total:Ct(Ui),errors:Ct(Qr),progress:Ct(Fi),finishedOnce:Ct(Ei)},Ll=()=>ro,so=(n,t)=>{const e=to(ws,t),{renderer:i}=mn();return e.load(n,{...t,transform:r=>(r.colorSpace=i.outputColorSpace,r.needsUpdate=!0,t?.transform?.(r)??r)})},Mn=new B,oe=new B,Zi=new B,Nl=n=>{const t=yt({width:0,height:0,factor:0,distance:0}),{camera:e,size:i,renderStage:r,scheduler:o}=mn(),s=(u,f,h)=>{t.update(l=>{const{width:d,height:m}=u;if(Array.isArray(n)&&Mn.fromArray(n),l.distance=h,Pt(f,"OrthographicCamera"))l.width=d/f.zoom,l.height=m/f.zoom,l.factor=1;else if(Pt(f,"PerspectiveCamera")){const x=f.fov*Math.PI/180,p=2*Math.tan(x/2)*h,y=p*(d/m);l.width=y,l.height=p,l.factor=d/y}return l})},c=Hi(e),a=Hi(i);return kr(()=>{if(c.current.getWorldPosition(oe),!oe.equals(Zi)){const u=oe.distanceTo(Mn);s(a.current,c.current,u),Zi.copy(oe)}},{autoInvalidate:!1,stage:o.createStage(Symbol("viewport-stage"),{before:r})}),Zr(()=>{const u=c.current.getWorldPosition(oe).distanceTo(Mn);s(a.current,c.current,u)}),t},Ue=new re,Xi=new k,Yi=new wi,An=new B,Vl=function(n,t){if(this.geometry.boundingSphere===null&&this.geometry.computeBoundingSphere(),Ue.copy(this.geometry.boundingSphere??Ue),Ue.applyMatrix4(this.matrixWorld),!n.ray.intersectsSphere(Ue)||(Xi.copy(this.matrixWorld).invert(),Yi.copy(n.ray).applyMatrix4(Xi),this.geometry.boundingBox!==null&&Yi.intersectBox(this.geometry.boundingBox,An)===null))return;const e=An.distanceTo(n.ray.origin),i=An.clone();t.push({distance:e,point:i,object:this})},ts=Symbol("THRELTE_SUSPENSE_CONTEXT_IDENTIFIER"),kl=n=>{const t=yt(new Set),e=yt(new Map),i=dn(!1),r=()=>{t.current.size===0&&e.current.size===0&&i.set(!0)},o=dn(n?.final??!1),s=d=>{t.update(m=>(m.add(d),m))},c=d=>{t.update(m=>(m.delete(d),m))},a=(d,m)=>{e.update(x=>(x.set(d,m),x))},u=d=>{e.update(m=>(m.delete(d),m))},f=Jn([t,e,o,i],([d,m,x,p])=>x&&p?!1:m.size>0?!0:d.size>0),h={suspend(d){s(d),d.catch(m=>{a(d,m)}).finally(()=>{c(d),r()})},onComponentDestroy(d){c(d),u(d),r()},suspended:f},l=Jn(e,d=>Array.from(d.values()));return js(ts,h),{promises:t,suspended:f,errors:l,setFinal:d=>o.set(d??!1)}},oo=()=>{const n=Ws(ts),t=new Set,e=r=>(n&&(n.suspend(r),t.add(r)),r),i={suspended:Jn(n?.suspended??Ys(!1),r=>r)};return Ks(()=>{if(n){for(const r of t)n.onComponentDestroy(r);t.clear()}}),Object.assign(e,i)};class ao extends Bt{constructor(t=new X,e=new B,i=new $r,r=new B(1,1,1)){super();const o=[],s=[],c=[],a=new B,u=new bs().getNormalMatrix(t.matrixWorld),f=new k;f.makeRotationFromEuler(i),f.setPosition(e);const h=new k;h.copy(f).invert(),l(),this.setAttribute("position",new Nt(o,3)),this.setAttribute("uv",new Nt(c,2)),s.length>0&&this.setAttribute("normal",new Nt(s,3));function l(){let p=[];const y=new B,g=new B,v=t.geometry,w=v.attributes.position,S=v.attributes.normal;if(v.index!==null){const _=v.index;for(let b=0;b<_.count;b++)y.fromBufferAttribute(w,_.getX(b)),S?(g.fromBufferAttribute(S,_.getX(b)),d(p,y,g)):d(p,y)}else{if(w===void 0)return;for(let _=0;_<w.count;_++)y.fromBufferAttribute(w,_),S?(g.fromBufferAttribute(S,_),d(p,y,g)):d(p,y)}p=m(p,a.set(1,0,0)),p=m(p,a.set(-1,0,0)),p=m(p,a.set(0,1,0)),p=m(p,a.set(0,-1,0)),p=m(p,a.set(0,0,1)),p=m(p,a.set(0,0,-1));for(let _=0;_<p.length;_++){const b=p[_];c.push(.5+b.position.x/r.x,.5+b.position.y/r.y),b.position.applyMatrix4(f),o.push(b.position.x,b.position.y,b.position.z),b.normal!==null&&s.push(b.normal.x,b.normal.y,b.normal.z)}}function d(p,y,g=null){y.applyMatrix4(t.matrixWorld),y.applyMatrix4(h),g?(g.applyNormalMatrix(u),p.push(new Pn(y.clone(),g.clone()))):p.push(new Pn(y.clone()))}function m(p,y){const g=[],v=.5*Math.abs(r.dot(y));for(let w=0;w<p.length;w+=3){let S=0,_,b,T,A;const M=p[w+0].position.dot(y)-v,P=p[w+1].position.dot(y)-v,D=p[w+2].position.dot(y)-v,z=M>0,E=P>0,C=D>0;switch(S=(z?1:0)+(E?1:0)+(C?1:0),S){case 0:{g.push(p[w]),g.push(p[w+1]),g.push(p[w+2]);break}case 1:{if(z&&(_=p[w+1],b=p[w+2],T=x(p[w],_,y,v),A=x(p[w],b,y,v)),E){_=p[w],b=p[w+2],T=x(p[w+1],_,y,v),A=x(p[w+1],b,y,v),g.push(T),g.push(b.clone()),g.push(_.clone()),g.push(b.clone()),g.push(T.clone()),g.push(A);break}C&&(_=p[w],b=p[w+1],T=x(p[w+2],_,y,v),A=x(p[w+2],b,y,v)),g.push(_.clone()),g.push(b.clone()),g.push(T),g.push(A),g.push(T.clone()),g.push(b.clone());break}case 2:{z||(_=p[w].clone(),b=x(_,p[w+1],y,v),T=x(_,p[w+2],y,v),g.push(_),g.push(b),g.push(T)),E||(_=p[w+1].clone(),b=x(_,p[w+2],y,v),T=x(_,p[w],y,v),g.push(_),g.push(b),g.push(T)),C||(_=p[w+2].clone(),b=x(_,p[w],y,v),T=x(_,p[w+1],y,v),g.push(_),g.push(b),g.push(T));break}}}return g}function x(p,y,g,v){const w=p.position.dot(g)-v,S=y.position.dot(g)-v,_=w/(w-S),b=new B(p.position.x+_*(y.position.x-p.position.x),p.position.y+_*(y.position.y-p.position.y),p.position.z+_*(y.position.z-p.position.z));let T=null;return p.normal!==null&&y.normal!==null&&(T=new B(p.normal.x+_*(y.normal.x-p.normal.x),p.normal.y+_*(y.normal.y-p.normal.y),p.normal.z+_*(y.normal.z-p.normal.z))),new Pn(b,T)}}}class Pn{constructor(t,e=null){this.position=t,this.normal=e}clone(){const t=this.position.clone(),e=this.normal!==null?this.normal.clone():null;return new this.constructor(t,e)}}const co=new B,Ki=new k,Ji=new B,lo=new B,gt=new Me;var uo=Xr("<!> <!> <!>",1),fo=Xr("<!> <!>",1);function $l(n,t){Ai(t,!0);const e=()=>qi(h,"$parent",r),i=()=>qi(st(v),"$map",r),[r,o]=Xs();let s=Mt(t,"polygonOffsetFactor",19,()=>-10),c=Mt(t,"depthTest",3,!0),a=Mt(t,"debug",3,!1),u=Mt(t,"ref",15),f=Kr(t,["$$slots","$$events","$$legacy","src","mesh","position","rotation","scale","polygonOffsetFactor","depthTest","debug","ref","children"]);const h=_s(),l=Wi(()=>t.mesh??e()),d=new X,m=new B,x=new $r,p=new B(1,1,1);let y=new X;const g=oo(),v=Wi(()=>typeof t.src=="string"?g(so(t.src)):t.src?on(Promise.resolve(t.src)):void 0);Zr(()=>{if(!("geometry"in st(l)))throw new Error('Decal must have a Mesh as parent or specify its "mesh" prop');if(!(!i()&&!t.children)){if(t.position!==void 0&&m.fromArray(t.position),t.scale!==void 0&&(typeof t.scale=="number"?p.setScalar(t.scale):p.fromArray(t.scale)),Ki.copy(st(l).matrixWorld),st(l).matrixWorld.identity(),t.rotation===void 0||typeof t.rotation=="number"){gt.matrixWorld.identity(),gt.position.copy(m);const b=st(l).geometry.attributes.position.array;st(l).geometry.attributes.normal===void 0&&st(l).geometry.computeVertexNormals();const T=st(l).geometry.attributes.normal.array;let A=1/0,M=-1;for(let P=0,D=b.length;P<D;P+=3){const z=co.fromArray(b,P).distanceToSquared(gt.position);z<A&&(A=z,M=P)}Ji.fromArray(T,M),gt.lookAt(lo.copy(gt.position).add(Ji)),gt.rotateZ(Math.PI),gt.rotateY(Math.PI),typeof t.rotation=="number"&&gt.rotateZ(t.rotation),x.copy(gt.rotation)}else x.fromArray(t.rotation);return d.geometry=new ao(st(l),m,x,p),st(l).matrixWorld.copy(Ki),a()&&(y.position.copy(m),y.rotation.copy(x),y.scale.copy(p)),()=>d.geometry.dispose()}});var w=Bi(),S=we(w);{var _=b=>{Tt(b,Yr({get is(){return d},"material.transparent":!0,"material.polygonOffset":!0,get"material.polygonOffsetFactor"(){return s()},get"material.depthTest"(){return c()},get"material.map"(){return i()}},()=>f,{threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Decal/Decal.svelte",index:0},get ref(){return u()},set ref(T){u(T)},children:(T,A)=>{var M=fo(),P=we(M);zi(P,()=>t.children??Di,()=>({ref:d}));var D=Sn(P,2);{var z=E=>{Tt(E,{get is(){return y},raycast:()=>null,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Decal/Decal.svelte",index:1},children:(C,I)=>{var V=uo(),lt=we(V);Tn(lt,()=>Tt.BoxGeometry,(Et,bt)=>{bt(Et,{threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Decal/Decal.svelte",index:2}})});var ut=Sn(lt,2);Tn(ut,()=>Tt.MeshNormalMaterial,(Et,bt)=>{bt(Et,{wireframe:!0,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Decal/Decal.svelte",index:3}})});var jt=Sn(ut,2);Tn(jt,()=>Tt.AxesHelper,(Et,bt)=>{bt(Et,{raycast:()=>null,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Decal/Decal.svelte",index:4}})}),be(C,V)},$$slots:{default:!0}})};Gi(D,E=>{a()&&E(z)})}be(T,M)},$$slots:{default:!0}}))};Gi(S,b=>{(i()||t.children)&&b(_)})}be(n,w),Pi(),o()}const kt=new B,gn=new B,ho=new B,po=new q,Hl=(n,t,e)=>{const i=kt.setFromMatrixPosition(n.matrixWorld);i.project(t);const r=e.width/2,o=e.height/2;return[i.x*r+r,-(i.y*o)+o]},jl=(n,t)=>{const e=kt.setFromMatrixPosition(n.matrixWorld),i=gn.setFromMatrixPosition(t.matrixWorld),r=e.sub(i),o=t.getWorldDirection(ho);return r.angleTo(o)>Math.PI/2},Wl=(n,t,e,i)=>{const r=kt.setFromMatrixPosition(n.matrixWorld),o=gn.copy(kt);o.project(t),e.setFromCamera(po.set(o.x,o.y),t);const s=e.intersectObjects(i,!0);if(s.length){const c=s[0].distance;return r.distanceTo(e.ray.origin)<c}return!0},Gl=(n,t)=>{if(Pt(t,"OrthographicCamera"))return t.zoom;if(Pt(t,"PerspectiveCamera")){const e=kt.setFromMatrixPosition(n.matrixWorld),i=gn.setFromMatrixPosition(t.matrixWorld),r=t.fov*Math.PI/180,o=e.distanceTo(i);return 1/(2*Math.tan(r/2)*o)}else return 1},ql=(n,t,e)=>{const i=kt.setFromMatrixPosition(n.matrixWorld),r=gn.setFromMatrixPosition(t.matrixWorld),o=i.distanceTo(r),s=(e[1]-e[0])/(t.far-t.near),c=e[1]-s*t.far;return Math.round(s*o+c)},Z=n=>Math.abs(n)<1e-10?0:n,es=(n,t,e="")=>{const{elements:i}=n;return`${e}matrix3d(
...
`;function Vo(n,t){Ai(t,!0),Jr(t.name,t.plugin);var e=Bi(),i=we(e);zi(i,()=>t.children??Di),be(n,e),Pi()}const su=`
...
void main() {
	...
	${at.tonemapping_fragment}
	${at.colorspace_fragment}
}`,as=0,ko=1,$o=2,mr=0,Ho=1,yr=2,Cn=1.25,gr=1,Se=32,xn=65535,jo=Math.pow(2,-24),In=Symbol("SKIP_GENERATION");function Wo(n){return n.index?n.index.count:n.attributes.position.count}function se(n){return Wo(n)/3}function Go(n,t=ArrayBuffer){return n>65535?new Uint32Array(new t(4*n)):new Uint16Array(new t(2*n))}function qo(n,t){if(!n.index){const e=n.attributes.position.count,i=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,r=Go(e,i);n.setIndex(new K(r,1));for(let o=0;o<e;o++)r[o]=o}}function cs(n,t){const e=se(n),i=t||n.drawRange,r=i.start/3,o=(i.start+i.count)/3,s=Math.max(0,r),c=Math.min(e,o)-s;return[{offset:Math.floor(s),count:Math.floor(c)}]}function ls(n,t){if(!n.groups||!n.groups.length)return cs(n,t);const e=[],i=new Set,r=t||n.drawRange,o=r.start/3,s=(r.start+r.count)/3;for(const a of n.groups){const u=a.start/3,f=(a.start+a.count)/3;i.add(Math.max(o,u)),i.add(Math.min(s,f))}const c=Array.from(i.values()).sort((a,u)=>a-u);for(let a=0;a<c.length-1;a++){const u=c[a],f=c[a+1];e.push({offset:Math.floor(u),count:Math.floor(f-u)})}return e}function Zo(n,t){const e=se(n),i=ls(n,t).sort((s,c)=>s.offset-c.offset),r=i[i.length-1];r.count=Math.min(e-r.offset,r.count);let o=0;return i.forEach(({count:s})=>o+=s),e!==o}function Un(n,t,e,i,r){let o=1/0,s=1/0,c=1/0,a=-1/0,u=-1/0,f=-1/0,h=1/0,l=1/0,d=1/0,m=-1/0,x=-1/0,p=-1/0;for(let y=t*6,g=(t+e)*6;y<g;y+=6){const v=n[y+0],w=n[y+1],S=v-w,_=v+w;S<o&&(o=S),_>a&&(a=_),v<h&&(h=v),v>m&&(m=v);const b=n[y+2],T=n[y+3],A=b-T,M=b+T;A<s&&(s=A),M>u&&(u=M),b<l&&(l=b),b>x&&(x=b);const P=n[y+4],D=n[y+5],z=P-D,E=P+D;z<c&&(c=z),E>f&&(f=E),P<d&&(d=P),P>p&&(p=P)}i[0]=o,i[1]=s,i[2]=c,i[3]=a,i[4]=u,i[5]=f,r[0]=h,r[1]=l,r[2]=d,r[3]=m,r[4]=x,r[5]=p}function Xo(n,t=null,e=null,i=null){const r=n.attributes.position,o=n.index?n.index.array:null,s=se(n),c=r.normalized;let a;t===null?(a=new Float32Array(s*6),e=0,i=s):(a=t,e=e||0,i=i||s);const u=r.array,f=r.offset||0;let h=3;r.isInterleavedBufferAttribute&&(h=r.data.stride);const l=["getX","getY","getZ"];for(let d=e;d<e+i;d++){const m=d*3,x=d*6;let p=m+0,y=m+1,g=m+2;o&&(p=o[p],y=o[y],g=o[g]),c||(p=p*h+f,y=y*h+f,g=g*h+f);for(let v=0;v<3;v++){let w,S,_;c?(w=r[l[v]](p),S=r[l[v]](y),_=r[l[v]](g)):(w=u[p+v],S=u[y+v],_=u[g+v]);let b=w;S<b&&(b=S),_<b&&(b=_);let T=w;S>T&&(T=S),_>T&&(T=_);const A=(T-b)/2,M=v*2;a[x+M+0]=b+A,a[x+M+1]=A+(Math.abs(b)+A)*jo}}return a}function O(n,t,e){return e.min.x=t[n],e.min.y=t[n+1],e.min.z=t[n+2],e.max.x=t[n+3],e.max.y=t[n+4],e.max.z=t[n+5],e}function xr(n){let t=-1,e=-1/0;for(let i=0;i<3;i++){const r=n[i+3]-n[i];r>e&&(e=r,t=i)}return t}function vr(n,t){t.set(n)}function wr(n,t,e){let i,r;for(let o=0;o<3;o++){const s=o+3;i=n[o],r=t[o],e[o]=i<r?i:r,i=n[s],r=t[s],e[s]=i>r?i:r}}function Ne(n,t,e){for(let i=0;i<3;i++){const r=t[n+2*i],o=t[n+2*i+1],s=r-o,c=r+o;s<e[i]&&(e[i]=s),c>e[i+3]&&(e[i+3]=c)}}function le(n){const t=n[3]-n[0],e=n[4]-n[1],i=n[5]-n[2];return 2*(t*e+e*i+i*t)}const xt=32,Yo=(n,t)=>n.candidate-t.candidate,_t=new Array(xt).fill().map(()=>({count:0,bounds:new Float32Array(6),rightCacheBounds:new Float32Array(6),leftCacheBounds:new Float32Array(6),candidate:0})),Ve=new Float32Array(6);function Ko(n,t,e,i,r,o){let s=-1,c=0;if(o===as)s=xr(t),s!==-1&&(c=(t[s]+t[s+3])/2);else if(o===ko)s=xr(n),s!==-1&&(c=Jo(e,i,r,s));else if(o===$o){const a=le(n);let u=Cn*r;const f=i*6,h=(i+r)*6;for(let l=0;l<3;l++){const d=t[l],p=(t[l+3]-d)/xt;if(r<xt/4){const y=[..._t];y.length=r;let g=0;for(let w=f;w<h;w+=6,g++){const S=y[g];S.candidate=e[w+2*l],S.count=0;const{bounds:_,leftCacheBounds:b,rightCacheBounds:T}=S;for(let A=0;A<3;A++)T[A]=1/0,T[A+3]=-1/0,b[A]=1/0,b[A+3]=-1/0,_[A]=1/0,_[A+3]=-1/0;Ne(w,e,_)}y.sort(Yo);let v=r;for(let w=0;w<v;w++){const S=y[w];for(;w+1<v&&y[w+1].candidate===S.candidate;)y.splice(w+1,1),v--}for(let w=f;w<h;w+=6){const S=e[w+2*l];for(let _=0;_<v;_++){const b=y[_];S>=b.candidate?Ne(w,e,b.rightCacheBounds):(Ne(w,e,b.leftCacheBounds),b.count++)}}for(let w=0;w<v;w++){const S=y[w],_=S.count,b=r-S.count,T=S.leftCacheBounds,A=S.rightCacheBounds;let M=0;_!==0&&(M=le(T)/a);let P=0;b!==0&&(P=le(A)/a);const D=gr+Cn*(M*_+P*b);D<u&&(s=l,u=D,c=S.candidate)}}else{for(let v=0;v<xt;v++){const w=_t[v];w.count=0,w.candidate=d+p+v*p;const S=w.bounds;for(let _=0;_<3;_++)S[_]=1/0,S[_+3]=-1/0}for(let v=f;v<h;v+=6){let _=~~((e[v+2*l]-d)/p);_>=xt&&(_=xt-1);const b=_t[_];b.count++,Ne(v,e,b.bounds)}const y=_t[xt-1];vr(y.bounds,y.rightCacheBounds);for(let v=xt-2;v>=0;v--){const w=_t[v],S=_t[v+1];wr(w.bounds,S.rightCacheBounds,w.rightCacheBounds)}let g=0;for(let v=0;v<xt-1;v++){const w=_t[v],S=w.count,_=w.bounds,T=_t[v+1].rightCacheBounds;S!==0&&(g===0?vr(_,Ve):wr(_,Ve,Ve)),g+=S;let A=0,M=0;g!==0&&(A=le(Ve)/a);const P=r-g;P!==0&&(M=le(T)/a);const D=gr+Cn*(A*g+M*P);D<u&&(s=l,u=D,c=w.candidate)}}}}else console.warn(`MeshBVH: Invalid build strategy value ${o} used.`);return{axis:s,pos:c}}function Jo(n,t,e,i){let r=0;for(let o=t,s=t+e;o<s;o++)r+=n[o*6+i*2];return r/e}class Fn{constructor(){this.boundingData=new Float32Array(6)}}function Qo(n,t,e,i,r,o){let s=i,c=i+r-1;const a=o.pos,u=o.axis*2;for(;;){for(;s<=c&&e[s*6+u]<a;)s++;for(;s<=c&&e[c*6+u]>=a;)c--;if(s<c){for(let f=0;f<3;f++){let h=t[s*3+f];t[s*3+f]=t[c*3+f],t[c*3+f]=h}for(let f=0;f<6;f++){let h=e[s*6+f];e[s*6+f]=e[c*6+f],e[c*6+f]=h}s++,c--}else return s}}function ta(n,t,e,i,r,o){let s=i,c=i+r-1;const a=o.pos,u=o.axis*2;for(;;){for(;s<=c&&e[s*6+u]<a;)s++;for(;s<=c&&e[c*6+u]>=a;)c--;if(s<c){let f=n[s];n[s]=n[c],n[c]=f;for(let h=0;h<6;h++){let l=e[s*6+h];e[s*6+h]=e[c*6+h],e[c*6+h]=l}s++,c--}else return s}}function Q(n,t){return t[n+15]===65535}function tt(n,t){return t[n+6]}function et(n,t){return t[n+14]}function nt(n){return n+8}function it(n,t){return t[n+6]}function us(n,t){return t[n+7]}function au(n){return n}let fs,ge,ln,ds;const ea=Math.pow(2,32);function si(n){return"count"in n?1:1+si(n.left)+si(n.right)}function na(n,t,e){return fs=new Float32Array(e),ge=new Uint32Array(e),ln=new Uint16Array(e),ds=new Uint8Array(e),oi(n,t)}function oi(n,t){const e=n/4,i=n/2,r="count"in t,o=t.boundingData;for(let s=0;s<6;s++)fs[e+s]=o[s];if(r)if(t.buffer){const s=t.buffer;ds.set(new Uint8Array(s),n);for(let c=n,a=n+s.byteLength;c<a;c+=Se){const u=c/2;Q(u,ln)||(ge[c/4+6]+=e)}return n+s.byteLength}else{const s=t.offset,c=t.count;return ge[e+6]=s,ln[i+14]=c,ln[i+15]=xn,n+Se}else{const s=t.left,c=t.right,a=t.splitAxis;let u;if(u=oi(n+Se,s),u/4>ea)throw new Error("MeshBVH: Cannot store child pointer greater than 32 bits.");return ge[e+6]=u/4,u=oi(u,c),ge[e+7]=a,u}}function ia(n,t){const e=(n.index?n.index.count:n.attributes.position.count)/3,i=e>2**16,r=i?4:2,o=t?new SharedArrayBuffer(e*r):new ArrayBuffer(e*r),s=i?new Uint32Array(o):new Uint16Array(o);for(let c=0,a=s.length;c<a;c++)s[c]=c;return s}function ra(n,t,e,i,r){const{maxDepth:o,verbose:s,maxLeafTris:c,strategy:a,onProgress:u,indirect:f}=r,h=n._indirectBuffer,l=n.geometry,d=l.index?l.index.array:null,m=f?ta:Qo,x=se(l),p=new Float32Array(6);let y=!1;const g=new Fn;return Un(t,e,i,g.boundingData,p),w(g,e,i,p),g;function v(S){u&&u(S/x)}function w(S,_,b,T=null,A=0){if(!y&&A>=o&&(y=!0,s&&(console.warn(`MeshBVH: Max depth of ${o} reached when generating BVH. Consider increasing maxDepth.`),console.warn(l))),b<=c||A>=o)return v(_+b),S.offset=_,S.count=b,S;const M=Ko(S.boundingData,T,t,_,b,a);if(M.axis===-1)return v(_+b),S.offset=_,S.count=b,S;const P=m(h,d,t,_,b,M);if(P===_||P===_+b)v(_+b),S.offset=_,S.count=b;else{S.splitAxis=M.axis;const D=new Fn,z=_,E=P-_;S.left=D,Un(t,z,E,D.boundingData,p),w(D,z,E,p,A+1);const C=new Fn,I=P,V=b-E;S.right=C,Un(t,I,V,C.boundingData,p),w(C,I,V,p,A+1)}return S}}function sa(n,t){const e=n.geometry;t.indirect&&(n._indirectBuffer=ia(e,t.useSharedArrayBuffer),Zo(e,t.range)&&!t.verbose&&console.warn('MeshBVH: Provided geometry contains groups or a range that do not fully span the vertex contents while using the "indirect" option. BVH may incorrectly report intersections on unrendered portions of the geometry.')),n._indirectBuffer||qo(e,t);const i=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,r=Xo(e),o=t.indirect?cs(e,t.range):ls(e,t.range);n._roots=o.map(s=>{const c=ra(n,r,s.offset,s.count,t),a=si(c),u=new i(Se*a);return na(0,c,u),u})}class wt{constructor(){this.min=1/0,this.max=-1/0}setFromPointsField(t,e){let i=1/0,r=-1/0;for(let o=0,s=t.length;o<s;o++){const a=t[o][e];i=a<i?a:i,r=a>r?a:r}this.min=i,this.max=r}setFromPoints(t,e){let i=1/0,r=-1/0;for(let o=0,s=e.length;o<s;o++){const c=e[o],a=t.dot(c);i=a<i?a:i,r=a>r?a:r}this.min=i,this.max=r}isSeparated(t){return this.min>t.max||t.min>this.max}}wt.prototype.setFromBox=(function(){const n=new B;return function(e,i){const r=i.min,o=i.max;let s=1/0,c=-1/0;for(let a=0;a<=1;a++)for(let u=0;u<=1;u++)for(let f=0;f<=1;f++){n.x=r.x*a+o.x*(1-a),n.y=r.y*u+o.y*(1-u),n.z=r.z*f+o.z*(1-f);const h=e.dot(n);s=Math.min(h,s),c=Math.max(h,c)}this.min=s,this.max=c}})();const oa=(function(){const n=new B,t=new B,e=new B;return function(r,o,s){const c=r.start,a=n,u=o.start,f=t;e.subVectors(c,u),n.subVectors(r.end,r.start),t.subVectors(o.end,o.start);const h=e.dot(f),l=f.dot(a),d=f.dot(f),m=e.dot(a),p=a.dot(a)*d-l*l;let y,g;p!==0?y=(h*l-m*d)/p:y=0,g=(h+y*l)/d,s.x=y,s.y=g}})(),Ni=(function(){const n=new q,t=new B,e=new B;return function(r,o,s,c){oa(r,o,n);let a=n.x,u=n.y;if(a>=0&&a<=1&&u>=0&&u<=1){r.at(a,s),o.at(u,c);return}else if(a>=0&&a<=1){u<0?o.at(0,c):o.at(1,c),r.closestPointToPoint(c,!0,s);return}else if(u>=0&&u<=1){a<0?r.at(0,s):r.at(1,s),o.closestPointToPoint(s,!0,c);return}else{let f;a<0?f=r.start:f=r.end;let h;u<0?h=o.start:h=o.end;const l=t,d=e;if(r.closestPointToPoint(h,!0,t),o.closestPointToPoint(f,!0,e),l.distanceToSquared(h)<=d.distanceToSquared(f)){s.copy(l),c.copy(h);return}else{s.copy(f),c.copy(d);return}}}})(),aa=(function(){const n=new B,t=new B,e=new Gr,i=new mt;return function(o,s){const{radius:c,center:a}=o,{a:u,b:f,c:h}=s;if(i.start=u,i.end=f,i.closestPointToPoint(a,!0,n).distanceTo(a)<=c||(i.start=u,i.end=h,i.closestPointToPoint(a,!0,n).distanceTo(a)<=c)||(i.start=f,i.end=h,i.closestPointToPoint(a,!0,n).distanceTo(a)<=c))return!0;const x=s.getPlane(e);if(Math.abs(x.distanceToPoint(a))<=c){const y=x.projectPoint(a,t);if(s.containsPoint(y))return!0}return!1}})(),ca=1e-15;function Rn(n){return Math.abs(n)<ca}class ct extends Qt{constructor(...t){super(...t),this.isExtendedTriangle=!0,this.satAxes=new Array(4).fill().map(()=>new B),this.satBounds=new Array(4).fill().map(()=>new wt),this.points=[this.a,this.b,this.c],this.sphere=new re,this.plane=new Gr,this.needsUpdate=!0}intersectsSphere(t){return aa(t,this)}update(){const t=this.a,e=this.b,i=this.c,r=this.points,o=this.satAxes,s=this.satBounds,c=o[0],a=s[0];this.getNormal(c),a.setFromPoints(c,r);const u=o[1],f=s[1];u.subVectors(t,e),f.setFromPoints(u,r);const h=o[2],l=s[2];h.subVectors(e,i),l.setFromPoints(h,r);const d=o[3],m=s[3];d.subVectors(i,t),m.setFromPoints(d,r),this.sphere.setFromPoints(this.points),this.plane.setFromNormalAndCoplanarPoint(c,t),this.needsUpdate=!1}}ct.prototype.closestPointToSegment=(function(){const n=new B,t=new B,e=new mt;return function(r,o=null,s=null){const{start:c,end:a}=r,u=this.points;let f,h=1/0;for(let l=0;l<3;l++){const d=(l+1)%3;e.start.copy(u[l]),e.end.copy(u[d]),Ni(e,r,n,t),f=n.distanceToSquared(t),f<h&&(h=f,o&&o.copy(n),s&&s.copy(t))}return this.closestPointToPoint(c,n),f=c.distanceToSquared(n),f<h&&(h=f,o&&o.copy(n),s&&s.copy(c)),this.closestPointToPoint(a,n),f=a.distanceToSquared(n),f<h&&(h=f,o&&o.copy(n),s&&s.copy(a)),Math.sqrt(h)}})();ct.prototype.intersectsTriangle=(function(){const n=new ct,t=new Array(3),e=new Array(3),i=new wt,r=new wt,o=new B,s=new B,c=new B,a=new B,u=new B,f=new mt,h=new mt,l=new mt,d=new B;function m(x,p,y){const g=x.points;let v=0,w=-1;for(let S=0;S<3;S++){const{start:_,end:b}=f;_.copy(g[S]),b.copy(g[(S+1)%3]),f.delta(s);const T=Rn(p.distanceToPoint(_));if(Rn(p.normal.dot(s))&&T){y.copy(f),v=2;break}const A=p.intersectLine(f,d);if(!A&&T&&d.copy(_),(A||T)&&!Rn(d.distanceTo(b))){if(v<=1)(v===1?y.start:y.end).copy(d),T&&(w=v);else if(v>=2){(w===1?y.start:y.end).copy(d),v=2;break}if(v++,v===2&&w===-1)break}}return v}return function(p,y=null,g=!1){this.needsUpdate&&this.update(),p.isExtendedTriangle?p.needsUpdate&&p.update():(n.copy(p),n.update(),p=n);const v=this.plane,w=p.plane;if(Math.abs(v.normal.dot(w.normal))>1-1e-10){const S=this.satBounds,_=this.satAxes;e[0]=p.a,e[1]=p.b,e[2]=p.c;for(let A=0;A<4;A++){const M=S[A],P=_[A];if(i.setFromPoints(P,e),M.isSeparated(i))return!1}const b=p.satBounds,T=p.satAxes;t[0]=this.a,t[1]=this.b,t[2]=this.c;for(let A=0;A<4;A++){const M=b[A],P=T[A];if(i.setFromPoints(P,t),M.isSeparated(i))return!1}for(let A=0;A<4;A++){const M=_[A];for(let P=0;P<4;P++){const D=T[P];if(o.crossVectors(M,D),i.setFromPoints(o,t),r.setFromPoints(o,e),i.isSeparated(r))return!1}}return y&&(g||console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."),y.start.set(0,0,0),y.end.set(0,0,0)),!0}else{const S=m(this,w,h);if(S===1&&p.containsPoint(h.end))return y&&(y.start.copy(h.end),y.end.copy(h.end)),!0;if(S!==2)return!1;const _=m(p,v,l);if(_===1&&this.containsPoint(l.end))return y&&(y.start.copy(l.end),y.end.copy(l.end)),!0;if(_!==2)return!1;if(h.delta(c),l.delta(a),c.dot(a)<0){let z=l.start;l.start=l.end,l.end=z}const b=h.start.dot(c),T=h.end.dot(c),A=l.start.dot(c),M=l.end.dot(c),P=T<A,D=b<M;return b!==M&&A!==T&&P===D?!1:(y&&(u.subVectors(h.start,l.start),u.dot(c)>0?y.start.copy(h.start):y.start.copy(l.start),u.subVectors(h.end,l.end),u.dot(c)<0?y.end.copy(h.end):y.end.copy(l.end)),!0)}}})();ct.prototype.distanceToPoint=(function(){const n=new B;return function(e){return this.closestPointToPoint(e,n),e.distanceTo(n)}})();ct.prototype.distanceToTriangle=(function(){const n=new B,t=new B,e=["a","b","c"],i=new mt,r=new mt;return function(s,c=null,a=null){const u=c||a?i:null;if(this.intersectsTriangle(s,u))return(c||a)&&(c&&u.getCenter(c),a&&u.getCenter(a)),0;let f=1/0;for(let h=0;h<3;h++){let l;const d=e[h],m=s[d];this.closestPointToPoint(m,n),l=m.distanceToSquared(n),l<f&&(f=l,c&&c.copy(n),a&&a.copy(m));const x=this[d];s.closestPointToPoint(x,n),l=x.distanceToSquared(n),l<f&&(f=l,c&&c.copy(x),a&&a.copy(n))}for(let h=0;h<3;h++){const l=e[h],d=e[(h+1)%3];i.set(this[l],this[d]);for(let m=0;m<3;m++){const x=e[m],p=e[(m+1)%3];r.set(s[x],s[p]),Ni(i,r,n,t);const y=n.distanceToSquared(t);y<f&&(f=y,c&&c.copy(n),a&&a.copy(t))}}return Math.sqrt(f)}})();class J{constructor(t,e,i){this.isOrientedBox=!0,this.min=new B,this.max=new B,this.matrix=new k,this.invMatrix=new k,this.points=new Array(8).fill().map(()=>new B),this.satAxes=new Array(3).fill().map(()=>new B),this.satBounds=new Array(3).fill().map(()=>new wt),this.alignedSatBounds=new Array(3).fill().map(()=>new wt),this.needsUpdate=!1,t&&this.min.copy(t),e&&this.max.copy(e),i&&this.matrix.copy(i)}set(t,e,i){this.min.copy(t),this.max.copy(e),this.matrix.copy(i),this.needsUpdate=!0}copy(t){this.min.copy(t.min),this.max.copy(t.max),this.matrix.copy(t.matrix),this.needsUpdate=!0}}J.prototype.update=(function(){return function(){const t=this.matrix,e=this.min,i=this.max,r=this.points;for(let u=0;u<=1;u++)for(let f=0;f<=1;f++)for(let h=0;h<=1;h++){const l=1*u|2*f|4*h,d=r[l];d.x=u?i.x:e.x,d.y=f?i.y:e.y,d.z=h?i.z:e.z,d.applyMatrix4(t)}const o=this.satBounds,s=this.satAxes,c=r[0];for(let u=0;u<3;u++){const f=s[u],h=o[u],l=1<<u,d=r[l];f.subVectors(c,d),h.setFromPoints(f,r)}const a=this.alignedSatBounds;a[0].setFromPointsField(r,"x"),a[1].setFromPointsField(r,"y"),a[2].setFromPointsField(r,"z"),this.invMatrix.copy(this.matrix).invert(),this.needsUpdate=!1}})();J.prototype.intersectsBox=(function(){const n=new wt;return function(e){this.needsUpdate&&this.update();const i=e.min,r=e.max,o=this.satBounds,s=this.satAxes,c=this.alignedSatBounds;if(n.min=i.x,n.max=r.x,c[0].isSeparated(n)||(n.min=i.y,n.max=r.y,c[1].isSeparated(n))||(n.min=i.z,n.max=r.z,c[2].isSeparated(n)))return!1;for(let a=0;a<3;a++){const u=s[a],f=o[a];if(n.setFromBox(u,e),f.isSeparated(n))return!1}return!0}})();J.prototype.intersectsTriangle=(function(){const n=new ct,t=new Array(3),e=new wt,i=new wt,r=new B;return function(s){this.needsUpdate&&this.update(),s.isExtendedTriangle?s.needsUpdate&&s.update():(n.copy(s),n.update(),s=n);const c=this.satBounds,a=this.satAxes;t[0]=s.a,t[1]=s.b,t[2]=s.c;for(let l=0;l<3;l++){const d=c[l],m=a[l];if(e.setFromPoints(m,t),d.isSeparated(e))return!1}const u=s.satBounds,f=s.satAxes,h=this.points;for(let l=0;l<3;l++){const d=u[l],m=f[l];if(e.setFromPoints(m,h),d.isSeparated(e))return!1}for(let l=0;l<3;l++){const d=a[l];for(let m=0;m<4;m++){const x=f[m];if(r.crossVectors(d,x),e.setFromPoints(r,t),i.setFromPoints(r,h),e.isSeparated(i))return!1}}return!0}})();J.prototype.closestPointToPoint=(function(){return function(t,e){return this.needsUpdate&&this.update(),e.copy(t).applyMatrix4(this.invMatrix).clamp(this.min,this.max).applyMatrix4(this.matrix),e}})();J.prototype.distanceToPoint=(function(){const n=new B;return function(e){return this.closestPointToPoint(e,n),e.distanceTo(n)}})();J.prototype.distanceToBox=(function(){const n=["x","y","z"],t=new Array(12).fill().map(()=>new mt),e=new Array(12).fill().map(()=>new mt),i=new B,r=new B;return function(s,c=0,a=null,u=null){if(this.needsUpdate&&this.update(),this.intersectsBox(s))return(a||u)&&(s.getCenter(r),this.closestPointToPoint(r,i),s.closestPointToPoint(i,r),a&&a.copy(i),u&&u.copy(r)),0;const f=c*c,h=s.min,l=s.max,d=this.points;let m=1/0;for(let p=0;p<8;p++){const y=d[p];r.copy(y).clamp(h,l);const g=y.distanceToSquared(r);if(g<m&&(m=g,a&&a.copy(y),u&&u.copy(r),g<f))return Math.sqrt(g)}let x=0;for(let p=0;p<3;p++)for(let y=0;y<=1;y++)for(let g=0;g<=1;g++){const v=(p+1)%3,w=(p+2)%3,S=y<<v|g<<w,_=1<<p|y<<v|g<<w,b=d[S],T=d[_];t[x].set(b,T);const M=n[p],P=n[v],D=n[w],z=e[x],E=z.start,C=z.end;E[M]=h[M],E[P]=y?h[P]:l[P],E[D]=g?h[D]:l[P],C[M]=l[M],C[P]=y?h[P]:l[P],C[D]=g?h[D]:l[P],x++}for(let p=0;p<=1;p++)for(let y=0;y<=1;y++)for(let g=0;g<=1;g++){r.x=p?l.x:h.x,r.y=y?l.y:h.y,r.z=g?l.z:h.z,this.closestPointToPoint(r,i);const v=r.distanceToSquared(i);if(v<m&&(m=v,a&&a.copy(i),u&&u.copy(r),v<f))return Math.sqrt(v)}for(let p=0;p<12;p++){const y=t[p];for(let g=0;g<12;g++){const v=e[g];Ni(y,v,i,r);const w=i.distanceToSquared(r);if(w<m&&(m=w,a&&a.copy(i),u&&u.copy(r),w<f))return Math.sqrt(w)}}return Math.sqrt(m)}})();class Vi{constructor(t){this._getNewPrimitive=t,this._primitives=[]}getPrimitive(){const t=this._primitives;return t.length===0?this._getNewPrimitive():t.pop()}releasePrimitive(t){this._primitives.push(t)}}class la extends Vi{constructor(){super(()=>new ct)}}const rt=new la;class ua{constructor(){this.float32Array=null,this.uint16Array=null,this.uint32Array=null;const t=[];let e=null;this.setBuffer=i=>{e&&t.push(e),e=i,this.float32Array=new Float32Array(i),this.uint16Array=new Uint16Array(i),this.uint32Array=new Uint32Array(i)},this.clearBuffer=()=>{e=null,this.float32Array=null,this.uint16Array=null,this.uint32Array=null,t.length!==0&&this.setBuffer(t.pop())}}}const R=new ua;let At,ee;const Gt=[],ke=new Vi(()=>new Y);function fa(n,t,e,i,r,o){At=ke.getPrimitive(),ee=ke.getPrimitive(),Gt.push(At,ee),R.setBuffer(n._roots[t]);const s=ai(0,n.geometry,e,i,r,o);R.clearBuffer(),ke.releasePrimitive(At),ke.releasePrimitive(ee),Gt.pop(),Gt.pop();const c=Gt.length;return c>0&&(ee=Gt[c-1],At=Gt[c-2]),s}function ai(n,t,e,i,r=null,o=0,s=0){const{float32Array:c,uint16Array:a,uint32Array:u}=R;let f=n*2;if(Q(f,a)){const l=tt(n,u),d=et(f,a);return O(n,c,At),i(l,d,!1,s,o+n,At)}else{let M=function(D){const{uint16Array:z,uint32Array:E}=R;let C=D*2;for(;!Q(C,z);)D=nt(D),C=D*2;return tt(D,E)},P=function(D){const{uint16Array:z,uint32Array:E}=R;let C=D*2;for(;!Q(C,z);)D=it(D,E),C=D*2;return tt(D,E)+et(C,z)};const l=nt(n),d=it(n,u);let m=l,x=d,p,y,g,v;if(r&&(g=At,v=ee,O(m,c,g),O(x,c,v),p=r(g),y=r(v),y<p)){m=d,x=l;const D=p;p=y,y=D,g=v}g||(g=At,O(m,c,g));const w=Q(m*2,a),S=e(g,w,p,s+1,o+m);let _;if(S===yr){const D=M(m),E=P(m)-D;_=i(D,E,!0,s+1,o+m,g)}else _=S&&ai(m,t,e,i,r,o,s+1);if(_)return!0;v=ee,O(x,c,v);const b=Q(x*2,a),T=e(v,b,y,s+1,o+x);let A;if(T===yr){const D=M(x),E=P(x)-D;A=i(D,E,!0,s+1,o+x,v)}else A=T&&ai(x,t,e,i,r,o,s+1);return!!A}}const ue=new B,On=new B;function da(n,t,e={},i=0,r=1/0){const o=i*i,s=r*r;let c=1/0,a=null;if(n.shapecast({boundsTraverseOrder:f=>(ue.copy(t).clamp(f.min,f.max),ue.distanceToSquared(t)),intersectsBounds:(f,h,l)=>l<c&&l<s,intersectsTriangle:(f,h)=>{f.closestPointToPoint(t,ue);const l=t.distanceToSquared(ue);return l<c&&(On.copy(ue),c=l,a=h),l<o}}),c===1/0)return null;const u=Math.sqrt(c);return e.point?e.point.copy(On):e.point=On.clone(),e.distance=u,e.faceIndex=a,e}const ha=parseInt(qr)>=169,Ft=new B,Rt=new B,Ot=new B,$e=new q,He=new q,je=new q,br=new B,_r=new B,Sr=new B,fe=new B;function pa(n,t,e,i,r,o,s,c){let a;if(o===jr?a=n.intersectTriangle(i,e,t,!0,r):a=n.intersectTriangle(t,e,i,o!==Cs,r),a===null)return null;const u=n.origin.distanceTo(r);return u<s||u>c?null:{distance:u,point:r.clone()}}function ma(n,t,e,i,r,o,s,c,a,u,f){Ft.fromBufferAttribute(t,o),Rt.fromBufferAttribute(t,s),Ot.fromBufferAttribute(t,c);const h=pa(n,Ft,Rt,Ot,fe,a,u,f);if(h){const l=new B;Qt.getBarycoord(fe,Ft,Rt,Ot,l),i&&($e.fromBufferAttribute(i,o),He.fromBufferAttribute(i,s),je.fromBufferAttribute(i,c),h.uv=Qt.getInterpolation(fe,Ft,Rt,Ot,$e,He,je,new q)),r&&($e.fromBufferAttribute(r,o),He.fromBufferAttribute(r,s),je.fromBufferAttribute(r,c),h.uv1=Qt.getInterpolation(fe,Ft,Rt,Ot,$e,He,je,new q)),e&&(br.fromBufferAttribute(e,o),_r.fromBufferAttribute(e,s),Sr.fromBufferAttribute(e,c),h.normal=Qt.getInterpolation(fe,Ft,Rt,Ot,br,_r,Sr,new B),h.normal.dot(n.direction)>0&&h.normal.multiplyScalar(-1));const d={a:o,b:s,c,normal:new B,materialIndex:0};Qt.getNormal(Ft,Rt,Ot,d.normal),h.face=d,h.faceIndex=o,ha&&(h.barycoord=l)}return h}function vn(n,t,e,i,r,o,s){const c=i*3;let a=c+0,u=c+1,f=c+2;const h=n.index;n.index&&(a=h.getX(a),u=h.getX(u),f=h.getX(f));const{position:l,normal:d,uv:m,uv1:x}=n.attributes,p=ma(e,l,d,m,x,a,u,f,t,o,s);return p?(p.faceIndex=i,r&&r.push(p),p):null}function N(n,t,e,i){const r=n.a,o=n.b,s=n.c;let c=t,a=t+1,u=t+2;e&&(c=e.getX(c),a=e.getX(a),u=e.getX(u)),r.x=i.getX(c),r.y=i.getY(c),r.z=i.getZ(c),o.x=i.getX(a),o.y=i.getY(a),o.z=i.getZ(a),s.x=i.getX(u),s.y=i.getY(u),s.z=i.getZ(u)}function ya(n,t,e,i,r,o,s,c){const{geometry:a,_indirectBuffer:u}=n;for(let f=i,h=i+r;f<h;f++)vn(a,t,e,f,o,s,c)}function ga(n,t,e,i,r,o,s){const{geometry:c,_indirectBuffer:a}=n;let u=1/0,f=null;for(let h=i,l=i+r;h<l;h++){let d;d=vn(c,t,e,h,null,o,s),d&&d.distance<u&&(f=d,u=d.distance)}return f}function xa(n,t,e,i,r,o,s){const{geometry:c}=e,{index:a}=c,u=c.attributes.position;for(let f=n,h=t+n;f<h;f++){let l;if(l=f,N(s,l*3,a,u),s.needsUpdate=!0,i(s,l,r,o))return!0}return!1}function va(n,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=n.geometry,i=e.index?e.index.array:null,r=e.attributes.position;let o,s,c,a,u=0;const f=n._roots;for(let l=0,d=f.length;l<d;l++)o=f[l],s=new Uint32Array(o),c=new Uint16Array(o),a=new Float32Array(o),h(0,u),u+=o.byteLength;function h(l,d,m=!1){const x=l*2;if(c[x+15]===xn){const y=s[l+6],g=c[x+14];let v=1/0,w=1/0,S=1/0,_=-1/0,b=-1/0,T=-1/0;for(let A=3*y,M=3*(y+g);A<M;A++){let P=i[A];const D=r.getX(P),z=r.getY(P),E=r.getZ(P);D<v&&(v=D),D>_&&(_=D),z<w&&(w=z),z>b&&(b=z),E<S&&(S=E),E>T&&(T=E)}return a[l+0]!==v||a[l+1]!==w||a[l+2]!==S||a[l+3]!==_||a[l+4]!==b||a[l+5]!==T?(a[l+0]=v,a[l+1]=w,a[l+2]=S,a[l+3]=_,a[l+4]=b,a[l+5]=T,!0):!1}else{const y=l+8,g=s[l+6],v=y+d,w=g+d;let S=m,_=!1,b=!1;t?S||(_=t.has(v),b=t.has(w),S=!_&&!b):(_=!0,b=!0);const T=S||_,A=S||b;let M=!1;T&&(M=h(y,d,S));let P=!1;A&&(P=h(g,d,S));const D=M||P;if(D)for(let z=0;z<3;z++){const E=y+z,C=g+z,I=a[E],V=a[E+3],lt=a[C],ut=a[C+3];a[l+z]=I<lt?I:lt,a[l+z+3]=V>ut?V:ut}return D}}}function Dt(n,t,e,i,r){let o,s,c,a,u,f;const h=1/e.direction.x,l=1/e.direction.y,d=1/e.direction.z,m=e.origin.x,x=e.origin.y,p=e.origin.z;let y=t[n],g=t[n+3],v=t[n+1],w=t[n+3+1],S=t[n+2],_=t[n+3+2];return h>=0?(o=(y-m)*h,s=(g-m)*h):(o=(g-m)*h,s=(y-m)*h),l>=0?(c=(v-x)*l,a=(w-x)*l):(c=(w-x)*l,a=(v-x)*l),o>a||c>s||((c>o||isNaN(o))&&(o=c),(a<s||isNaN(s))&&(s=a),d>=0?(u=(S-p)*d,f=(_-p)*d):(u=(_-p)*d,f=(S-p)*d),o>f||u>s)?!1:((u>o||o!==o)&&(o=u),(f<s||s!==s)&&(s=f),o<=r&&s>=i)}function wa(n,t,e,i,r,o,s,c){const{geometry:a,_indirectBuffer:u}=n;for(let f=i,h=i+r;f<h;f++){let l=u?u[f]:f;vn(a,t,e,l,o,s,c)}}function ba(n,t,e,i,r,o,s){const{geometry:c,_indirectBuffer:a}=n;let u=1/0,f=null;for(let h=i,l=i+r;h<l;h++){let d;d=vn(c,t,e,a?a[h]:h,null,o,s),d&&d.distance<u&&(f=d,u=d.distance)}return f}function _a(n,t,e,i,r,o,s){const{geometry:c}=e,{index:a}=c,u=c.attributes.position;for(let f=n,h=t+n;f<h;f++){let l;if(l=e.resolveTriangleIndex(f),N(s,l*3,a,u),s.needsUpdate=!0,i(s,l,r,o))return!0}return!1}function Sa(n,t,e,i,r,o,s){R.setBuffer(n._roots[t]),ci(0,n,e,i,r,o,s),R.clearBuffer()}function ci(n,t,e,i,r,o,s){const{float32Array:c,uint16Array:a,uint32Array:u}=R,f=n*2;if(Q(f,a)){const l=tt(n,u),d=et(f,a);ya(t,e,i,l,d,r,o,s)}else{const l=nt(n);Dt(l,c,i,o,s)&&ci(l,t,e,i,r,o,s);const d=it(n,u);Dt(d,c,i,o,s)&&ci(d,t,e,i,r,o,s)}}const Ta=["x","y","z"];function Ma(n,t,e,i,r,o){R.setBuffer(n._roots[t]);const s=li(0,n,e,i,r,o);return R.clearBuffer(),s}function li(n,t,e,i,r,o){const{float32Array:s,uint16Array:c,uint32Array:a}=R;let u=n*2;if(Q(u,c)){const h=tt(n,a),l=et(u,c);return ga(t,e,i,h,l,r,o)}else{const h=us(n,a),l=Ta[h],m=i.direction[l]>=0;let x,p;m?(x=nt(n),p=it(n,a)):(x=it(n,a),p=nt(n));const g=Dt(x,s,i,r,o)?li(x,t,e,i,r,o):null;if(g){const S=g.point[l];if(m?S<=s[p+h]:S>=s[p+h+3])return g}const w=Dt(p,s,i,r,o)?li(p,t,e,i,r,o):null;return g&&w?g.distance<=w.distance?g:w:g||w||null}}const We=new Y,qt=new ct,Zt=new ct,de=new k,Tr=new J,Ge=new J;function Aa(n,t,e,i){R.setBuffer(n._roots[t]);const r=ui(0,n,e,i);return R.clearBuffer(),r}function ui(n,t,e,i,r=null){const{float32Array:o,uint16Array:s,uint32Array:c}=R;let a=n*2;if(r===null&&(e.boundingBox||e.computeBoundingBox(),Tr.set(e.boundingBox.min,e.boundingBox.max,i),r=Tr),Q(a,s)){const f=t.geometry,h=f.index,l=f.attributes.position,d=e.index,m=e.attributes.position,x=tt(n,c),p=et(a,s);if(de.copy(i).invert(),e.boundsTree)return O(n,o,Ge),Ge.matrix.copy(de),Ge.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:g=>Ge.intersectsBox(g),intersectsTriangle:g=>{g.a.applyMatrix4(i),g.b.applyMatrix4(i),g.c.applyMatrix4(i),g.needsUpdate=!0;for(let v=x*3,w=(p+x)*3;v<w;v+=3)if(N(Zt,v,h,l),Zt.needsUpdate=!0,g.intersectsTriangle(Zt))return!0;return!1}});for(let y=x*3,g=(p+x)*3;y<g;y+=3){N(qt,y,h,l),qt.a.applyMatrix4(de),qt.b.applyMatrix4(de),qt.c.applyMatrix4(de),qt.needsUpdate=!0;for(let v=0,w=d.count;v<w;v+=3)if(N(Zt,v,d,m),Zt.needsUpdate=!0,qt.intersectsTriangle(Zt))return!0}}else{const f=n+8,h=c[n+6];return O(f,o,We),!!(r.intersectsBox(We)&&ui(f,t,e,i,r)||(O(h,o,We),r.intersectsBox(We)&&ui(h,t,e,i,r)))}}const qe=new k,Ln=new J,he=new J,Pa=new B,Da=new B,Ba=new B,za=new B;function Ea(n,t,e,i={},r={},o=0,s=1/0){t.boundingBox||t.computeBoundingBox(),Ln.set(t.boundingBox.min,t.boundingBox.max,e),Ln.needsUpdate=!0;const c=n.geometry,a=c.attributes.position,u=c.index,f=t.attributes.position,h=t.index,l=rt.getPrimitive(),d=rt.getPrimitive();let m=Pa,x=Da,p=null,y=null;r&&(p=Ba,y=za);let g=1/0,v=null,w=null;return qe.copy(e).invert(),he.matrix.copy(qe),n.shapecast({boundsTraverseOrder:S=>Ln.distanceToBox(S),intersectsBounds:(S,_,b)=>b<g&&b<s?(_&&(he.min.copy(S.min),he.max.copy(S.max),he.needsUpdate=!0),!0):!1,intersectsRange:(S,_)=>{if(t.boundsTree)return t.boundsTree.shapecast({boundsTraverseOrder:T=>he.distanceToBox(T),intersectsBounds:(T,A,M)=>M<g&&M<s,intersectsRange:(T,A)=>{for(let M=T,P=T+A;M<P;M++){N(d,3*M,h,f),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let D=S,z=S+_;D<z;D++){N(l,3*D,u,a),l.needsUpdate=!0;const E=l.distanceToTriangle(d,m,p);if(E<g&&(x.copy(m),y&&y.copy(p),g=E,v=D,w=M),E<o)return!0}}}});{const b=se(t);for(let T=0,A=b;T<A;T++){N(d,3*T,h,f),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let M=S,P=S+_;M<P;M++){N(l,3*M,u,a),l.needsUpdate=!0;const D=l.distanceToTriangle(d,m,p);if(D<g&&(x.copy(m),y&&y.copy(p),g=D,v=M,w=T),D<o)return!0}}}}}),rt.releasePrimitive(l),rt.releasePrimitive(d),g===1/0?null:(i.point?i.point.copy(x):i.point=x.clone(),i.distance=g,i.faceIndex=v,r&&(r.point?r.point.copy(y):r.point=y.clone(),r.point.applyMatrix4(qe),x.applyMatrix4(qe),r.distance=x.sub(r.point).length(),r.faceIndex=w),i)}function Ca(n,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=n.geometry,i=e.index?e.index.array:null,r=e.attributes.position;let o,s,c,a,u=0;const f=n._roots;for(let l=0,d=f.length;l<d;l++)o=f[l],s=new Uint32Array(o),c=new Uint16Array(o),a=new Float32Array(o),h(0,u),u+=o.byteLength;function h(l,d,m=!1){const x=l*2;if(c[x+15]===xn){const y=s[l+6],g=c[x+14];let v=1/0,w=1/0,S=1/0,_=-1/0,b=-1/0,T=-1/0;for(let A=y,M=y+g;A<M;A++){const P=3*n.resolveTriangleIndex(A);for(let D=0;D<3;D++){let z=P+D;z=i?i[z]:z;const E=r.getX(z),C=r.getY(z),I=r.getZ(z);E<v&&(v=E),E>_&&(_=E),C<w&&(w=C),C>b&&(b=C),I<S&&(S=I),I>T&&(T=I)}}return a[l+0]!==v||a[l+1]!==w||a[l+2]!==S||a[l+3]!==_||a[l+4]!==b||a[l+5]!==T?(a[l+0]=v,a[l+1]=w,a[l+2]=S,a[l+3]=_,a[l+4]=b,a[l+5]=T,!0):!1}else{const y=l+8,g=s[l+6],v=y+d,w=g+d;let S=m,_=!1,b=!1;t?S||(_=t.has(v),b=t.has(w),S=!_&&!b):(_=!0,b=!0);const T=S||_,A=S||b;let M=!1;T&&(M=h(y,d,S));let P=!1;A&&(P=h(g,d,S));const D=M||P;if(D)for(let z=0;z<3;z++){const E=y+z,C=g+z,I=a[E],V=a[E+3],lt=a[C],ut=a[C+3];a[l+z]=I<lt?I:lt,a[l+z+3]=V>ut?V:ut}return D}}}function Ia(n,t,e,i,r,o,s){R.setBuffer(n._roots[t]),fi(0,n,e,i,r,o,s),R.clearBuffer()}function fi(n,t,e,i,r,o,s){const{float32Array:c,uint16Array:a,uint32Array:u}=R,f=n*2;if(Q(f,a)){const l=tt(n,u),d=et(f,a);wa(t,e,i,l,d,r,o,s)}else{const l=nt(n);Dt(l,c,i,o,s)&&fi(l,t,e,i,r,o,s);const d=it(n,u);Dt(d,c,i,o,s)&&fi(d,t,e,i,r,o,s)}}const Ua=["x","y","z"];function Fa(n,t,e,i,r,o){R.setBuffer(n._roots[t]);const s=di(0,n,e,i,r,o);return R.clearBuffer(),s}function di(n,t,e,i,r,o){const{float32Array:s,uint16Array:c,uint32Array:a}=R;let u=n*2;if(Q(u,c)){const h=tt(n,a),l=et(u,c);return ba(t,e,i,h,l,r,o)}else{const h=us(n,a),l=Ua[h],m=i.direction[l]>=0;let x,p;m?(x=nt(n),p=it(n,a)):(x=it(n,a),p=nt(n));const g=Dt(x,s,i,r,o)?di(x,t,e,i,r,o):null;if(g){const S=g.point[l];if(m?S<=s[p+h]:S>=s[p+h+3])return g}const w=Dt(p,s,i,r,o)?di(p,t,e,i,r,o):null;return g&&w?g.distance<=w.distance?g:w:g||w||null}}const Ze=new Y,Xt=new ct,Yt=new ct,pe=new k,Mr=new J,Xe=new J;function Ra(n,t,e,i){R.setBuffer(n._roots[t]);const r=hi(0,n,e,i);return R.clearBuffer(),r}function hi(n,t,e,i,r=null){const{float32Array:o,uint16Array:s,uint32Array:c}=R;let a=n*2;if(r===null&&(e.boundingBox||e.computeBoundingBox(),Mr.set(e.boundingBox.min,e.boundingBox.max,i),r=Mr),Q(a,s)){const f=t.geometry,h=f.index,l=f.attributes.position,d=e.index,m=e.attributes.position,x=tt(n,c),p=et(a,s);if(pe.copy(i).invert(),e.boundsTree)return O(n,o,Xe),Xe.matrix.copy(pe),Xe.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:g=>Xe.intersectsBox(g),intersectsTriangle:g=>{g.a.applyMatrix4(i),g.b.applyMatrix4(i),g.c.applyMatrix4(i),g.needsUpdate=!0;for(let v=x,w=p+x;v<w;v++)if(N(Yt,3*t.resolveTriangleIndex(v),h,l),Yt.needsUpdate=!0,g.intersectsTriangle(Yt))return!0;return!1}});for(let y=x,g=p+x;y<g;y++){const v=t.resolveTriangleIndex(y);N(Xt,3*v,h,l),Xt.a.applyMatrix4(pe),Xt.b.applyMatrix4(pe),Xt.c.applyMatrix4(pe),Xt.needsUpdate=!0;for(let w=0,S=d.count;w<S;w+=3)if(N(Yt,w,d,m),Yt.needsUpdate=!0,Xt.intersectsTriangle(Yt))return!0}}else{const f=n+8,h=c[n+6];return O(f,o,Ze),!!(r.intersectsBox(Ze)&&hi(f,t,e,i,r)||(O(h,o,Ze),r.intersectsBox(Ze)&&hi(h,t,e,i,r)))}}const Ye=new k,Nn=new J,me=new J,Oa=new B,La=new B,Na=new B,Va=new B;function ka(n,t,e,i={},r={},o=0,s=1/0){t.boundingBox||t.computeBoundingBox(),Nn.set(t.boundingBox.min,t.boundingBox.max,e),Nn.needsUpdate=!0;const c=n.geometry,a=c.attributes.position,u=c.index,f=t.attributes.position,h=t.index,l=rt.getPrimitive(),d=rt.getPrimitive();let m=Oa,x=La,p=null,y=null;r&&(p=Na,y=Va);let g=1/0,v=null,w=null;return Ye.copy(e).invert(),me.matrix.copy(Ye),n.shapecast({boundsTraverseOrder:S=>Nn.distanceToBox(S),intersectsBounds:(S,_,b)=>b<g&&b<s?(_&&(me.min.copy(S.min),me.max.copy(S.max),me.needsUpdate=!0),!0):!1,intersectsRange:(S,_)=>{if(t.boundsTree){const b=t.boundsTree;return b.shapecast({boundsTraverseOrder:T=>me.distanceToBox(T),intersectsBounds:(T,A,M)=>M<g&&M<s,intersectsRange:(T,A)=>{for(let M=T,P=T+A;M<P;M++){const D=b.resolveTriangleIndex(M);N(d,3*D,h,f),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let z=S,E=S+_;z<E;z++){const C=n.resolveTriangleIndex(z);N(l,3*C,u,a),l.needsUpdate=!0;const I=l.distanceToTriangle(d,m,p);if(I<g&&(x.copy(m),y&&y.copy(p),g=I,v=z,w=M),I<o)return!0}}}})}else{const b=se(t);for(let T=0,A=b;T<A;T++){N(d,3*T,h,f),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let M=S,P=S+_;M<P;M++){const D=n.resolveTriangleIndex(M);N(l,3*D,u,a),l.needsUpdate=!0;const z=l.distanceToTriangle(d,m,p);if(z<g&&(x.copy(m),y&&y.copy(p),g=z,v=M,w=T),z<o)return!0}}}}}),rt.releasePrimitive(l),rt.releasePrimitive(d),g===1/0?null:(i.point?i.point.copy(x):i.point=x.clone(),i.distance=g,i.faceIndex=v,r&&(r.point?r.point.copy(y):r.point=y.clone(),r.point.applyMatrix4(Ye),x.applyMatrix4(Ye),r.distance=x.sub(r.point).length(),r.faceIndex=w),i)}function $a(){return typeof SharedArrayBuffer<"u"}const Te=new R.constructor,hn=new R.constructor,St=new Vi(()=>new Y),Kt=new Y,Jt=new Y,Vn=new Y,kn=new Y;let $n=!1;function Ha(n,t,e,i){if($n)throw new Error("MeshBVH: Recursive calls to bvhcast not supported.");$n=!0;const r=n._roots,o=t._roots;let s,c=0,a=0;const u=new k().copy(e).invert();for(let f=0,h=r.length;f<h;f++){Te.setBuffer(r[f]),a=0;const l=St.getPrimitive();O(0,Te.float32Array,l),l.applyMatrix4(u);for(let d=0,m=o.length;d<m&&(hn.setBuffer(o[d]),s=ot(0,0,e,u,i,c,a,0,0,l),hn.clearBuffer(),a+=o[d].length,!s);d++);if(St.releasePrimitive(l),Te.clearBuffer(),c+=r[f].length,s)break}return $n=!1,s}function ot(n,t,e,i,r,o=0,s=0,c=0,a=0,u=null,f=!1){let h,l;f?(h=hn,l=Te):(h=Te,l=hn);const d=h.float32Array,m=h.uint32Array,x=h.uint16Array,p=l.float32Array,y=l.uint32Array,g=l.uint16Array,v=n*2,w=t*2,S=Q(v,x),_=Q(w,g);let b=!1;if(_&&S)f?b=r(tt(t,y),et(t*2,g),tt(n,m),et(n*2,x),a,s+t,c,o+n):b=r(tt(n,m),et(n*2,x),tt(t,y),et(t*2,g),c,o+n,a,s+t);else if(_){const T=St.getPrimitive();O(t,p,T),T.applyMatrix4(e);const A=nt(n),M=it(n,m);O(A,d,Kt),O(M,d,Jt);const P=T.intersectsBox(Kt),D=T.intersectsBox(Jt);b=P&&ot(t,A,i,e,r,s,o,a,c+1,T,!f)||D&&ot(t,M,i,e,r,s,o,a,c+1,T,!f),St.releasePrimitive(T)}else{const T=nt(t),A=it(t,y);O(T,p,Vn),O(A,p,kn);const M=u.intersectsBox(Vn),P=u.intersectsBox(kn);if(M&&P)b=ot(n,T,e,i,r,o,s,c,a+1,u,f)||ot(n,A,e,i,r,o,s,c,a+1,u,f);else if(M)if(S)b=ot(n,T,e,i,r,o,s,c,a+1,u,f);else{const D=St.getPrimitive();D.copy(Vn).applyMatrix4(e);const z=nt(n),E=it(n,m);O(z,d,Kt),O(E,d,Jt);const C=D.intersectsBox(Kt),I=D.intersectsBox(Jt);b=C&&ot(T,z,i,e,r,s,o,a,c+1,D,!f)||I&&ot(T,E,i,e,r,s,o,a,c+1,D,!f),St.releasePrimitive(D)}else if(P)if(S)b=ot(n,A,e,i,r,o,s,c,a+1,u,f);else{const D=St.getPrimitive();D.copy(kn).applyMatrix4(e);const z=nt(n),E=it(n,m);O(z,d,Kt),O(E,d,Jt);const C=D.intersectsBox(Kt),I=D.intersectsBox(Jt);b=C&&ot(A,z,i,e,r,s,o,a,c+1,D,!f)||I&&ot(A,E,i,e,r,s,o,a,c+1,D,!f),St.releasePrimitive(D)}}return b}const Ke=new J,Ar=new Y,ja={strategy:as,maxDepth:40,maxLeafTris:10,useSharedArrayBuffer:!1,setBoundingBox:!0,onProgress:null,indirect:!1,verbose:!0,range:null};class ie{static serialize(t,e={}){e={cloneBuffers:!0,...e};const i=t.geometry,r=t._roots,o=t._indirectBuffer,s=i.getIndex();let c;return e.cloneBuffers?c={roots:r.map(a=>a.slice()),index:s?s.array.slice():null,indirectBuffer:o?o.slice():null}:c={roots:r,index:s?s.array:null,indirectBuffer:o},c}static deserialize(t,e,i={}){i={setIndex:!0,indirect:!!t.indirectBuffer,...i};const{index:r,roots:o,indirectBuffer:s}=t,c=new ie(e,{...i,[In]:!0});if(c._roots=o,c._indirectBuffer=s||null,i.setIndex){const a=e.getIndex();if(a===null){const u=new K(t.index,1,!1);e.setIndex(u)}else a.array!==r&&(a.array.set(r),a.needsUpdate=!0)}return c}get indirect(){return!!this._indirectBuffer}constructor(t,e={}){if(t.isBufferGeometry){if(t.index&&t.index.isInterleavedBufferAttribute)throw new Error("MeshBVH: InterleavedBufferAttribute is not supported for the index attribute.")}else throw new Error("MeshBVH: Only BufferGeometries are supported.");if(e=Object.assign({...ja,[In]:!1},e),e.useSharedArrayBuffer&&!$a())throw new Error("MeshBVH: SharedArrayBuffer is not available.");this.geometry=t,this._roots=null,this._indirectBuffer=null,e[In]||(sa(this,e),!t.boundingBox&&e.setBoundingBox&&(t.boundingBox=this.getBoundingBox(new Y))),this.resolveTriangleIndex=e.indirect?i=>this._indirectBuffer[i]:i=>i}refit(t=null){return(this.indirect?Ca:va)(this,t)}traverse(t,e=0){const i=this._roots[e],r=new Uint32Array(i),o=new Uint16Array(i);s(0);function s(c,a=0){const u=c*2,f=o[u+15]===xn;if(f){const h=r[c+6],l=o[u+14];t(a,f,new Float32Array(i,c*4,6),h,l)}else{const h=c+Se/4,l=r[c+6],d=r[c+7];t(a,f,new Float32Array(i,c*4,6),d)||(s(h,a+1),s(l,a+1))}}}raycast(t,e=Kn,i=0,r=1/0){const o=this._roots,s=this.geometry,c=[],a=e.isMaterial,u=Array.isArray(e),f=s.groups,h=a?e.side:e,l=this.indirect?Ia:Sa;for(let d=0,m=o.length;d<m;d++){const x=u?e[f[d].materialIndex].side:h,p=c.length;if(l(this,d,x,t,c,i,r),u){const y=f[d].materialIndex;for(let g=p,v=c.length;g<v;g++)c[g].face.materialIndex=y}}return c}raycastFirst(t,e=Kn,i=0,r=1/0){const o=this._roots,s=this.geometry,c=e.isMaterial,a=Array.isArray(e);let u=null;const f=s.groups,h=c?e.side:e,l=this.indirect?Fa:Ma;for(let d=0,m=o.length;d<m;d++){const x=a?e[f[d].materialIndex].side:h,p=l(this,d,x,t,i,r);p!=null&&(u==null||p.distance<u.distance)&&(u=p,a&&(p.face.materialIndex=f[d].materialIndex))}return u}intersectsGeometry(t,e){let i=!1;const r=this._roots,o=this.indirect?Ra:Aa;for(let s=0,c=r.length;s<c&&(i=o(this,s,t,e),!i);s++);return i}shapecast(t){const e=rt.getPrimitive(),i=this.indirect?_a:xa;let{boundsTraverseOrder:r,intersectsBounds:o,intersectsRange:s,intersectsTriangle:c}=t;if(s&&c){const h=s;s=(l,d,m,x,p)=>h(l,d,m,x,p)?!0:i(l,d,this,c,m,x,e)}else s||(c?s=(h,l,d,m)=>i(h,l,this,c,d,m,e):s=(h,l,d)=>d);let a=!1,u=0;const f=this._roots;for(let h=0,l=f.length;h<l;h++){const d=f[h];if(a=fa(this,h,o,s,r,u),a)break;u+=d.byteLength}return rt.releasePrimitive(e),a}bvhcast(t,e,i){let{intersectsRanges:r,intersectsTriangles:o}=i;const s=rt.getPrimitive(),c=this.geometry.index,a=this.geometry.attributes.position,u=this.indirect?m=>{const x=this.resolveTriangleIndex(m);N(s,x*3,c,a)}:m=>{N(s,m*3,c,a)},f=rt.getPrimitive(),h=t.geometry.index,l=t.geometry.attributes.position,d=t.indirect?m=>{const x=t.resolveTriangleIndex(m);N(f,x*3,h,l)}:m=>{N(f,m*3,h,l)};if(o){const m=(x,p,y,g,v,w,S,_)=>{for(let b=y,T=y+g;b<T;b++){d(b),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let A=x,M=x+p;A<M;A++)if(u(A),s.needsUpdate=!0,o(s,f,A,b,v,w,S,_))return!0}return!1};if(r){const x=r;r=function(p,y,g,v,w,S,_,b){return x(p,y,g,v,w,S,_,b)?!0:m(p,y,g,v,w,S,_,b)}}else r=m}return Ha(this,t,e,r)}intersectsBox(t,e){return Ke.set(t.min,t.max,e),Ke.needsUpdate=!0,this.shapecast({intersectsBounds:i=>Ke.intersectsBox(i),intersectsTriangle:i=>Ke.intersectsTriangle(i)})}intersectsSphere(t){return this.shapecast({intersectsBounds:e=>t.intersectsBox(e),intersectsTriangle:e=>e.intersectsSphere(t)})}closestPointToGeometry(t,e,i={},r={},o=0,s=1/0){return(this.indirect?ka:Ea)(this,t,e,i,r,o,s)}closestPointToPoint(t,e={},i=0,r=1/0){return da(this,t,e,i,r)}getBoundingBox(t){return t.makeEmpty(),this._roots.forEach(i=>{O(0,new Float32Array(i),Ar),t.union(Ar)}),t}}const Pr=new Y,Dr=new k;class Wa extends Me{get isMesh(){return!this.displayEdges}get isLineSegments(){return this.displayEdges}get isLine(){return this.displayEdges}getVertexPosition(...t){return X.prototype.getVertexPosition.call(this,...t)}constructor(t,e,i=10,r=0){super(),this.material=e,this.geometry=new Bt,this.name="MeshBVHRootHelper",this.depth=i,this.displayParents=!1,this.bvh=t,this.displayEdges=!0,this._group=r}raycast(){}update(){const t=this.geometry,e=this.bvh,i=this._group;if(t.dispose(),this.visible=!1,e){const r=this.depth-1,o=this.displayParents;let s=0;e.traverse((l,d)=>{if(l>=r||d)return s++,!0;o&&s++},i);let c=0;const a=new Float32Array(24*s);e.traverse((l,d,m)=>{const x=l>=r||d;if(x||o){O(0,m,Pr);const{min:p,max:y}=Pr;for(let g=-1;g<=1;g+=2){const v=g<0?p.x:y.x;for(let w=-1;w<=1;w+=2){const S=w<0?p.y:y.y;for(let _=-1;_<=1;_+=2){const b=_<0?p.z:y.z;a[c+0]=v,a[c+1]=S,a[c+2]=b,c+=3}}}return x}},i);let u,f;this.displayEdges?f=new Uint8Array([0,4,1,5,2,6,3,7,0,2,1,3,4,6,5,7,0,1,2,3,4,5,6,7]):f=new Uint8Array([0,1,2,2,1,3,4,6,5,6,7,5,1,4,5,0,4,1,2,3,6,3,7,6,0,2,4,2,6,4,1,5,3,3,5,7]),a.length>65535?u=new Uint32Array(f.length*s):u=new Uint16Array(f.length*s);const h=f.length;for(let l=0;l<s;l++){const d=l*8,m=l*h;for(let x=0;x<h;x++)u[m+x]=d+f[x]}t.setIndex(new K(u,1,!1)),t.setAttribute("position",new K(a,3,!1)),this.visible=!0}}}class Ie extends ve{get color(){return this.edgeMaterial.color}get opacity(){return this.edgeMaterial.opacity}set opacity(t){this.edgeMaterial.opacity=t,this.meshMaterial.opacity=t}constructor(t=null,e=null,i=10){t instanceof ie&&(i=e||10,e=t,t=null),typeof e=="number"&&(i=e,e=null),super(),this.name="MeshBVHHelper",this.depth=i,this.mesh=t,this.bvh=e,this.displayParents=!1,this.displayEdges=!0,this.objectIndex=0,this._roots=[];const r=new Is({color:65416,transparent:!0,opacity:.3,depthWrite:!1}),o=new Ht({color:65416,transparent:!0,opacity:.3,depthWrite:!1});o.color=r.color,this.edgeMaterial=r,this.meshMaterial=o,this.update()}update(){const t=this.mesh;let e=this.bvh||t.geometry.boundsTree||null;if(t.isBatchedMesh&&t.boundsTrees&&!e){const r=t._drawInfo[this.objectIndex];r&&(e=t.boundsTrees[r.geometryIndex]||e)}const i=e?e._roots.length:0;for(;this._roots.length>i;){const r=this._roots.pop();r.geometry.dispose(),this.remove(r)}for(let r=0;r<i;r++){const{depth:o,edgeMaterial:s,meshMaterial:c,displayParents:a,displayEdges:u}=this;if(r>=this._roots.length){const h=new Wa(e,s,o,r);this.add(h),this._roots.push(h)}const f=this._roots[r];f.bvh=e,f.depth=o,f.displayParents=a,f.displayEdges=u,f.material=u?s:c,f.update()}}updateMatrixWorld(...t){const e=this.mesh,i=this.parent;e!==null&&(e.updateWorldMatrix(!0,!1),i?this.matrix.copy(i.matrixWorld).invert().multiply(e.matrixWorld):this.matrix.copy(e.matrixWorld),(e.isInstancedMesh||e.isBatchedMesh)&&(e.getMatrixAt(this.objectIndex,Dr),this.matrix.multiply(Dr)),this.matrix.decompose(this.position,this.quaternion,this.scale)),super.updateMatrixWorld(...t)}copy(t){this.depth=t.depth,this.mesh=t.mesh,this.bvh=t.bvh,this.opacity=t.opacity,this.color.copy(t.color)}clone(){return new Ie(this.mesh,this.bvh,this.depth)}dispose(){this.edgeMaterial.dispose(),this.meshMaterial.dispose();const t=this.children;for(let e=0,i=t.length;e<i;e++)t[e].geometry.dispose()}}function Br(n,t,e){return n===null?null:(n.point.applyMatrix4(t.matrixWorld),n.distance=n.point.distanceTo(e.ray.origin),n.object=t,n)}const Ga=parseInt(qr)>=166,Je=new wi,zr=new B,Er=new k,qa=X.prototype.raycast,Za=sn.prototype.raycast,Cr=new B,j=new X,Qe=[];function hs(n,t){this.isBatchedMesh?Xa.call(this,n,t):Ya.call(this,n,t)}function Xa(n,t){if(this.boundsTrees){const e=this.boundsTrees,i=this._drawInfo||this._instanceInfo,r=this._drawRanges||this._geometryInfo,o=this.matrixWorld;j.material=this.material,j.geometry=this.geometry;const s=j.geometry.boundsTree,c=j.geometry.drawRange;j.geometry.boundingSphere===null&&(j.geometry.boundingSphere=new re);for(let a=0,u=i.length;a<u;a++){if(!this.getVisibleAt(a))continue;const f=i[a].geometryIndex;if(j.geometry.boundsTree=e[f],this.getMatrixAt(a,j.matrixWorld).premultiply(o),!j.geometry.boundsTree){this.getBoundingBoxAt(f,j.geometry.boundingBox),this.getBoundingSphereAt(f,j.geometry.boundingSphere);const h=r[f];j.geometry.setDrawRange(h.start,h.count)}j.raycast(n,Qe);for(let h=0,l=Qe.length;h<l;h++){const d=Qe[h];d.object=this,d.batchId=a,t.push(d)}Qe.length=0}j.geometry.boundsTree=s,j.geometry.drawRange=c,j.material=null,j.geometry=null}else Za.call(this,n,t)}function Ya(n,t){if(this.geometry.boundsTree){if(this.material===void 0)return;Er.copy(this.matrixWorld).invert(),Je.copy(n.ray).applyMatrix4(Er),Cr.setFromMatrixScale(this.matrixWorld),zr.copy(Je.direction).multiply(Cr);const e=zr.length(),i=n.near/e,r=n.far/e,o=this.geometry.boundsTree;if(n.firstHitOnly===!0){const s=Br(o.raycastFirst(Je,this.material,i,r),this,n);s&&t.push(s)}else{const s=o.raycast(Je,this.material,i,r);for(let c=0,a=s.length;c<a;c++){const u=Br(s[c],this,n);u&&t.push(u)}}}else qa.call(this,n,t)}function Ka(n={}){return this.boundsTree=new ie(this,n),this.boundsTree}function Ja(){this.boundsTree=null}function Qa(n=-1,t={}){if(!Ga)throw new Error("BatchedMesh: Three r166+ is required to compute bounds trees.");t.indirect&&console.warn('"Indirect" is set to false because it is not supported for BatchedMesh.'),t={...t,indirect:!1,range:null};const e=this._drawRanges||this._geometryInfo,i=this._geometryCount;this.boundsTrees||(this.boundsTrees=new Array(i).fill(null));const r=this.boundsTrees;for(;r.length<i;)r.push(null);if(n<0){for(let o=0;o<i;o++)t.range=e[o],r[o]=new ie(this.geometry,t);return r}else return n<e.length&&(t.range=e[n],r[n]=new ie(this.geometry,t)),r[n]||null}function tc(n=-1){n<0?this.boundsTrees.fill(null):n<this.boundsTree.length&&(this.boundsTrees[n]=null)}const ec=`
...
void main() {
	...
	${at.tonemapping_fragment}
	${at.colorspace_fragment}
}`,oc=new Y;function lu(n,t){Ai(t,!0);const{renderStage:e}=mn();let i=Mt(t,"auto",3,!1),r=Mt(t,"box",3,oc),o=Mt(t,"stage",19,()=>Js("<Resize>",{before:e})),s=Mt(t,"ref",15),c=Kr(t,["$$slots","$$events","$$legacy","axis","auto","box","precise","onresize","stage","ref","children"]);const a=new ve,u=new ve,f=new ve,h=()=>{f.matrixWorld.identity();const{max:y,min:g}=r().setFromObject(u,t.precise),v=y.x-g.x,w=y.y-g.y,S=y.z-g.z,_=t.axis==="x"?v:t.axis==="y"?w:t.axis==="z"?S:Math.max(v,w,S);f.scale.setScalar(1/_),t.onresize?.()};let l=Gs(!1);const d=()=>{qs(l,!0)};kr(()=>{h(),stop()},{stage:o(),running:()=>st(l)});const m=d;ji(()=>[t.axis,t.precise],d);const x=y=>{Pt(y.ref,"Object3D")&&ji.pre(()=>[y.ref],()=>(i()&&d(),()=>{i()&&d()}))};var p={resize:m};return Tt(n,Yr({get is(){return a}},()=>c,{threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Resize/Resize.svelte",index:0},get ref(){return s()},set ref(y){s(y)},children:(y,g)=>{Tt(y,{get is(){return f},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Resize/Resize.svelte",index:1},children:(v,w)=>{Tt(v,{get is(){return u},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/Resize/Resize.svelte",index:2},children:(S,_)=>{Vo(S,{name:"resize",plugin:x,children:(b,T)=>{var A=Bi(),M=we(A);zi(M,()=>t.children??Di,()=>({ref:a,resize:d})),be(b,A)},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}})),Pi(p)}const Hn=typeof window<"u"?document.createElement("div"):void 0,uu=()=>{Jr("transitions",n=>{if(!Hn||!n.props.in&&!n.props.out&&!n.props.transition)return;const{invalidate:t}=mn();Hn.dispatchEvent=c=>(c.type==="introstart"?n.props.onintrostart?.():c.type==="outrostart"?n.props.onoutrostart?.():c.type==="introend"?n.props.onintroend?.():c.type==="outroend"&&n.props.onoutroend?.(),!0);const e=c=>(a,u,f)=>{const h=c(n.ref,{direction:f.direction});return{...h,tick(...l){t(),h?.tick?.(...l)}}},i=["in","out","transition"],r={in:5,out:6,transition:7},o={in:1,out:2,transition:3},s=Zs;s&&!("transitions"in s)&&s.nodes==null&&(s.nodes={start:null,end:null,a:null,t:null});for(const c of i){const a=n.props[c];if(a){const f="global"in a?r[c]:o[c];Qs(f,Hn,()=>e(a))}}return{pluginProps:["in","out","transition","onintrostart","onoutrostart","onintroend","onoutroend"]}})};var ac=Object.defineProperty,cc=(n,t,e)=>t in n?ac(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,F=(n,t,e)=>(cc(n,typeof t!="symbol"?t+"":t,e),e);const ps=/\bvoid\s+main\s*\(\s*\)\s*{/g;function pi(n){const t=/^[ \t]*#include +<([\w\d./]+)>/gm;function e(i,r){let o=at[r];return o?pi(o):i}return n.replace(t,e)}const W=[];for(let n=0;n<256;n++)W[n]=(n<16?"0":"")+n.toString(16);function lc(){const n=Math.random()*4294967295|0,t=Math.random()*4294967295|0,e=Math.random()*4294967295|0,i=Math.random()*4294967295|0;return(W[n&255]+W[n>>8&255]+W[n>>16&255]+W[n>>24&255]+"-"+W[t&255]+W[t>>8&255]+"-"+W[t>>16&15|64]+W[t>>24&255]+"-"+W[e&63|128]+W[e>>8&255]+"-"+W[e>>16&255]+W[e>>24&255]+W[i&255]+W[i>>8&255]+W[i>>16&255]+W[i>>24&255]).toUpperCase()}const Lt=Object.assign||function(){let n=arguments[0];for(let t=1,e=arguments.length;t<e;t++){let i=arguments[t];if(i)for(let r in i)Object.prototype.hasOwnProperty.call(i,r)&&(n[r]=i[r])}return n},uc=Date.now(),Ir=new WeakMap,Ur=new Map;let fc=1e10;function pn(n,t){const e=mc(t);let i=Ir.get(n);if(i||Ir.set(n,i=Object.create(null)),i[e])return new i[e];const r=`_onBeforeCompile${e}`,o=function(u,f){n.onBeforeCompile.call(this,u,f);const h=this.customProgramCacheKey()+"|"+u.vertexShader+"|"+u.fragmentShader;let l=Ur[h];if(!l){const d=dc(this,u,t,e);l=Ur[h]=d}u.vertexShader=l.vertexShader,u.fragmentShader=l.fragmentShader,Lt(u.uniforms,this.uniforms),t.timeUniform&&(u.uniforms[t.timeUniform]={get value(){return Date.now()-uc}}),this[r]&&this[r](u)},s=function(){return c(t.chained?n:n.clone())},c=function(u){const f=Object.create(u,a);return Object.defineProperty(f,"baseMaterial",{value:n}),Object.defineProperty(f,"id",{value:fc++}),f.uuid=lc(),f.uniforms=Lt({},u.uniforms,t.uniforms),f.defines=Lt({},u.defines,t.defines),f.defines[`TROIKA_DERIVED_MATERIAL_${e}`]="",f.extensions=Lt({},u.extensions,t.extensions),f._listeners=void 0,f},a={constructor:{value:s},isDerivedMaterial:{value:!0},type:{get:()=>n.type,set:u=>{n.type=u}},isDerivedFrom:{writable:!0,configurable:!0,value:function(u){const f=this.baseMaterial;return u===f||f.isDerivedMaterial&&f.isDerivedFrom(u)||!1}},customProgramCacheKey:{writable:!0,configurable:!0,value:function(){return n.customProgramCacheKey()+"|"+e}},onBeforeCompile:{get(){return o},set(u){this[r]=u}},copy:{writable:!0,configurable:!0,value:function(u){return n.copy.call(this,u),!n.isShaderMaterial&&!n.isDerivedMaterial&&(Lt(this.extensions,u.extensions),Lt(this.defines,u.defines),Lt(this.uniforms,bi.clone(u.uniforms))),this}},clone:{writable:!0,configurable:!0,value:function(){const u=new n.constructor;return c(u).copy(this)}},getDepthMaterial:{writable:!0,configurable:!0,value:function(){let u=this._depthMaterial;return u||(u=this._depthMaterial=pn(n.isDerivedMaterial?n.getDepthMaterial():new ks({depthPacking:$s}),t),u.defines.IS_DEPTH_MATERIAL="",u.uniforms=this.uniforms),u}},getDistanceMaterial:{writable:!0,configurable:!0,value:function(){let u=this._distanceMaterial;return u||(u=this._distanceMaterial=pn(n.isDerivedMaterial?n.getDistanceMaterial():new Vs,t),u.defines.IS_DISTANCE_MATERIAL="",u.uniforms=this.uniforms),u}},dispose:{writable:!0,configurable:!0,value(){const{_depthMaterial:u,_distanceMaterial:f}=this;u&&u.dispose(),f&&f.dispose(),n.dispose.call(this)}}};return i[e]=s,new s}function dc(n,{vertexShader:t,fragmentShader:e},i,r){let{vertexDefs:o,vertexMainIntro:s,vertexMainOutro:c,vertexTransform:a,fragmentDefs:u,fragmentMainIntro:f,fragmentMainOutro:h,fragmentColorTransform:l,customRewriter:d,timeUniform:m}=i;if(o=o||"",s=s||"",c=c||"",u=u||"",f=f||"",h=h||"",(a||d)&&(t=pi(t)),(l||d)&&(e=e.replace(/^[ \t]*#include <((?:tonemapping|encodings|colorspace|fog|premultiplied_alpha|dithering)_fragment)>/gm,`
//!BEGIN_POST_CHUNK $1
$&
//!END_POST_CHUNK
...
${s}
`,t=t.replace(/\b(position|normal|uv)\b/g,(x,p,y,g)=>/\battribute\s+vec[23]\s+$/.test(g.substr(0,y))?p:`troika_${p}_${r}`),n.map&&n.map.channel>0||(t=t.replace(/\bMAP_UV\b/g,`troika_uv_${r}`))),t=Fr(t,r,o,s,c),e=Fr(e,r,u,f,h),{vertexShader:t,fragmentShader:e}}function Fr(n,t,e,i,r){return(i||r||e)&&(n=n.replace(ps,`
${e}
