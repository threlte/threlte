import"./disclose-version.DsnmJJEf.js";import{p as M,f as v,s as S,a as w}from"./runtime.HAn2cbcW.js";import{f as A,a as g}from"./template.D0onEdCl.js";import{aN as y,a as x,b4 as D,aR as b,aS as _,i as O,av as o,T as u}from"./observe.svelte.BoKeyuw0.js";/* empty css                                                      */import{u as P}from"./useTask.svelte.sgAOcP65.js";const k=`
  ...
  `,c=(t,e)=>{t.onBeforeCompile=a=>{a.uniforms.uShadowOpacity=e.uShadowOpacity,a.uniforms.uAlphaMap=e.uAlphaMap,a.uniforms.uHasAlphaMap=e.uHasAlphaMap,a.fragmentShader=a.fragmentShader.replace("void main() {",`
        ...
        `)}};var H=A("<!> <!>",1);function j(t,e){M(e,!0);const a={uShadowOpacity:new o(1),uAlphaMap:new o(null),uHasAlphaMap:new o(!1)},l=new y({depthPacking:x}),p=new D;c(l,a),c(p,a);const m=b(_());P(()=>{const h=m.current;if(!O(h,"Mesh"))return;const r=h.material;if(!r)return;const f=e.opacity??r.opacity??1,s=e.alphaMap===!1?null:e.alphaMap??r.alphaMap??null;a.uShadowOpacity.value=f,a.uAlphaMap.value=s,a.uHasAlphaMap.value=s!==null});var n=H(),i=v(n);u(i,{get is(){return l},attach:"customDepthMaterial",threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/ShadowAlpha/ShadowAlpha.svelte",index:0}});var d=S(i,2);u(d,{get is(){return p},attach:"customDistanceMaterial",threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/packages/extras/src/lib/components/ShadowAlpha/ShadowAlpha.svelte",index:1}}),g(t,n),w()}export{j as S};
