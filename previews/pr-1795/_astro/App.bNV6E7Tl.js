import"./disclose-version.DsnmJJEf.js";import"./legacy.CUIl4KX-.js";import{p as he,f as T,g as l,n as ie,s as R,a as ue,P as be,u as le,L as me,d as re,bx as Ce,b as ae,c as Se,r as we}from"./runtime.D20saW8m.js";import{c as I,f as L,a as x}from"./template.DY3hUOmN.js";import{C as Pe}from"./Canvas.CXRz6bAw.js";import{aE as N,fV as Z,V as M,as as X,aU as Y,aF as Re,e3 as ye,fh as Ae,ac as Ee,b3 as De,bL as Fe,bM as Ue,bN as Be,bO as Ie,bP as Ne,bQ as ze,ej as Oe,C as z,l as F,cs as Le,M as ke,T as b,bZ as Ge,cm as $e,bY as Qe,cx as Ve,a0 as He,D as We,b as ge,f_ as je,bW as Xe,U as Ye,aX as Ke}from"./observe.svelte.DDw9hZ_4.js";import{e as Ze}from"./events.D9j-qKmp.js";import{c as C}from"./svelte-component.C-qodc9T.js";import{a as ve,s as qe}from"./store.Djq20Duq.js";/* empty css                                                      */import{u as xe}from"./useTask.svelte.DgOMa9PG.js";import{a as Me}from"./raycast.B6Zw1_kC.js";import{O as Je}from"./OrbitControls.CrWp9T58.js";import{s as oe}from"./snippet.ZYtLD8wA.js";import{a as ne}from"./await.BumtOvqZ.js";import{p as et,s as tt,r as st}from"./props.BLzNsRtJ.js";import{u as it}from"./useGltf.ZR5rIxEC.js";import{u as rt}from"./useDraco.DQjgTMF8.js";import{e as at}from"./each.CiIpPjm0.js";import{I as ot,a as lt}from"./Instance._Ezc4L0P.js";import{P as k,F as fe}from"./Pass.Cdk1Cs3_.js";/* empty css                                                   */import"./if.KLqBe-U_.js";import"./branches.HJW2H96n.js";import"./index.XLhfXAo9.js";import"./create-subscriber.DvowZspB.js";import"./index-client.Ci3t-hyE.js";import"./useStage.D-sVePfc.js";import"./injectPlugin.DRFifCzz.js";import"./transitions.Dv_byTtB.js";import"./loop.BGGTUj09.js";import"./render.CEiySluT.js";import"./utils.NcpWCyqV.js";import"./OrbitControls.BHSexTlS.js";import"./useControlsContext.q2OBSLe7.js";import"./useThrelteUserContext.CqzfZKqo.js";import"./GLTFLoader.D-tR-qzR.js";import"./BufferGeometryUtils.TdCEhyr-.js";const K={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}O.BlurDirectionX=new M(1,0);O.BlurDirectionY=new M(0,1);var dt=L("<!> <!>",1),mt=L("<!> <!> <!>",1),gt=L("<!> <!>",1);function vt(g,e){he(e,!0);let t=et(e,"ref",15),i=st(e,["$$slots","$$events","$$legacy","fallback","error","children","ref"]);const o=rt(),s=it("/spaceship-tutorial/models/spaceship-transformed.glb",{dracoLoader:o}),a=Me("/spaceship-tutorial/textures/energy-beam-opacity.png");function u(r){r.transparent=!0,r.alphaToCoverage=!0,r.depthFunc=Ve,r.depthTest=!0,r.depthWrite=!0}s.then(r=>{u(r.materials.spaceship_racer),u(r.materials.cockpit)});var n=I(),y=T(n);C(y,()=>b.Group,(r,f)=>{f(r,tt({dispose:!1},()=>i,{threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:0},get ref(){return t()},set ref(c){t(c)},children:(c,q)=>{var S=gt(),_=T(S);ne(_,()=>s,v=>{var h=I(),p=T(h);oe(p,()=>e.fallback??ie),x(v,h)},(v,h)=>{var p=I(),P=T(p);C(P,()=>b.Group,(U,G)=>{G(U,{scale:.003,rotation:[0,-Math.PI*.5,0],position:[.95,0,0],threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:1},children:($,pe)=>{var Q=mt(),B=T(Q);C(B,()=>b.Mesh,(A,E)=>{E(A,{castShadow:!0,receiveShadow:!0,get geometry(){return l(h).nodes.Cube001_spaceship_racer_0.geometry},get material(){return l(h).materials.spaceship_racer},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:2}})});var H=R(B,2);C(H,()=>b.Mesh,(A,E)=>{E(A,{castShadow:!0,receiveShadow:!0,get geometry(){return l(h).nodes.Cube005_cockpit_0.geometry},get material(){return l(h).materials.cockpit},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:3}})});var W=R(H,2);ne(W,()=>a,null,(A,E)=>{var V=I(),J=T(V);C(J,()=>b.Mesh,(d,m)=>{m(d,{position:[0,0,-1350],"rotation.x":Math.PI*.5,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:4},children:(D,ee)=>{var ce=dt(),de=T(ce);C(de,()=>b.CylinderGeometry,(te,se)=>{se(te,{args:[70,25,1600,15],threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:5}})});var Te=R(de,2);C(Te,()=>b.MeshBasicMaterial,(te,se)=>{se(te,{color:[1,.4,.02],get alphaMap(){return l(E)},transparent:!0,get blending(){return Qe},get blendDst(){return $e},get blendEquation(){return Ge},threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/models/spaceship.svelte",index:6}})}),x(D,ce)},$$slots:{default:!0}})}),x(A,V)}),x($,Q)},$$slots:{default:!0}})}),x(v,p)},(v,h)=>{var p=I(),P=T(p);oe(P,()=>e.error??ie,()=>({error:l(h)})),x(v,p)});var w=R(_,2);oe(w,()=>e.children??ie,()=>({ref:t()})),x(c,S)},$$slots:{default:!0}}))}),x(g,n),ue()}var _t=L("<!> <!> <!>",1);function xt(g,e){he(e,!0);let t=350,i=["#fcaa67","#C75D59","#ffffc7","#8CC5C6","#A5898C"],o=be([]);const s=Me("/spaceship-tutorial/textures/star.png");function a(r,f){let c=Math.random()*(f-r);return r+c}function u(r){a(0,1)>.8?(r.position=[a(-10,-30),a(-5,5),a(6,-6)],r.length=a(1.5,15)):(r.position=[a(-15,-45),a(-10.5,1.5),a(30,-45)],r.length=a(2.5,20)),r.speed=a(19.5,42),r.color.set(i[Math.floor(Math.random()*i.length)]??"white").convertSRGBToLinear().multiplyScalar(1.3)}for(let r=0;r<t;r++){const f={id:He.generateUUID(),position:[0,0,0],length:0,speed:0,color:new z};u(f),o.push(f)}xe(r=>{for(const f of o)f.position[0]+=f.speed*r,f.position[0]>40&&u(f)});var n=I(),y=T(n);ne(y,()=>s,null,(r,f)=>{ot(r,{limit:t,range:t,children:(c,q)=>{var S=_t(),_=T(S);C(_,()=>b.PlaneGeometry,(h,p)=>{p(h,{args:[1,.05],threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Stars.svelte",index:0}})});var w=R(_,2);C(w,()=>b.MeshBasicMaterial,(h,p)=>{p(h,{get side(){return We},get alphaMap(){return l(f)},transparent:!0,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Stars.svelte",index:1}})});var v=R(w,2);at(v,17,()=>o,({id:h,position:p,length:P,color:U})=>h,(h,p)=>{let P=()=>l(p).position,U=()=>l(p).length,G=()=>l(p).color;{let $=le(()=>[U(),1,1]);lt(h,{get position(){return P()},get scale(){return l($)},get color(){return G()}})}}),x(c,S)},$$slots:{default:!0}})}),x(g,n),ue()}var Mt=L("<!> <!> <!> <!>",1);function Tt(g,e){he(e,!0);const t=()=>ve(n,"$camera",o),i=()=>ve(u,"$size",o),[o,s]=qe(),{scene:a,size:u,camera:n,renderer:y}=ge();let r,f=0,c=0,q=new je(y),S,_=re(void 0),w=re(0),v=re(0);const h=new ut(y),p=new pt(a,t()),P=new O(new M(i().width,i().height),.275,1,0),U=new ft;h.addPass(p),h.addPass(P),h.addPass(U),me(()=>{h.setSize(i().width,i().height),P.resolution.set(i().width,i().height)}),me(()=>{p.camera=t()});const{renderStage:G}=ge();xe(()=>{if(r){const d=r?.y||0;f+=(d-l(w))*.002,f*=.95,ae(w,l(w)+f);const D=r.clone().sub(new F(0,l(w),0)).normalize().dot(new F(0,1,0)),ee=Math.acos(D)-Math.PI*.5;c+=(ee-l(v))*.01,c*=.85,ae(v,l(v)+c)}S&&S.dispose(),l(_)&&(l(_).visible=!1,a.background=null,S=q.fromScene(a,0,.1,1e3),a.background=new z("#598889").multiplyScalar(.05),l(_).visible=!0,l(_).traverse(d=>{if("material"in d){const m=d.material;"envMapIntensity"in m&&(m.envMap=S.texture,m.envMapIntensity=100,m.normalScale.set(.3,.3))}})),h.render()},{stage:G});const $=new Xe(20,20),pe=new Ye($),Q=new Ke,B=new M;function H(d){B.x=d.clientX/window.innerWidth*2-1,B.y=-(d.clientY/window.innerHeight)*2+1,Q.setFromCamera(B,t()),r=Q.intersectObject(pe)[0]?.point,r&&(r.x=3)}var W=Mt();Ze("pointermove",Ce,H);var A=T(W);C(A,()=>b.PerspectiveCamera,(d,m)=>{m(d,{makeDefault:!0,position:[-10,6,15],fov:25,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Scene.svelte",index:0},children:(D,ee)=>{Je(D,{enableDamping:!0,enableZoom:!1,target:[0,0,0]})},$$slots:{default:!0}})});var E=R(A,2);C(E,()=>b.DirectionalLight,(d,m)=>{m(d,{intensity:1.8,position:[0,10,0],castShadow:!0,"shadow.bias":-1e-4,threlteStudio:{moduleId:"/home/runner/work/threlte/threlte/apps/docs/src/examples/tutorials/animating-a-spaceship/Scene.svelte",index:1}})});var V=R(E,2);{let d=le(()=>[0,l(w),0]),m=le(()=>[l(v),0,l(v),"ZXY"]);vt(V,{get position(){return l(d)},get rotation(){return l(m)},get ref(){return l(_)},set ref(D){ae(_,D,!0)}})}var J=R(V,2);xt(J,{}),x(g,W),ue(),s()}var bt=L('<div class="svelte-1tcrzz0"><!></div>');function ls(g){var e=bt(),t=Se(e);Pe(t,{autoRender:!1,children:(i,o)=>{Tt(i,{})},$$slots:{default:!0}}),we(e),x(g,e)}export{ls as default};
