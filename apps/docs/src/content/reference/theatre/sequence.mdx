...
componentSignature:
  {
    props:
      [
		...
		{name: 'autoplay', type: 'boolean', default: 'false', required: false, description: "Choose whether to automatically play the animation when the component is mounted (Threlte)"},
		...
		{name: 'autoreset', type: '"always" | "onMount" | "onDestroy" | undefined', default: 'undefined', required: false, description: "Reset the playhead when the component is mounted, unmounted**, both or neither (Threlte)"},
		{name: 'autopause', type: 'boolean', default: 'false', required: false, description: "Whether to pause playback when the component is unmounted (Threlte)"},
