...
componentSignature:
  {
    pretext: 'In addition to the props listed below, <code>&lt;Sync&gt;</code> accepts any property of its parent Three.js object as a prop, with a value of <code>boolean | string | ComplexProp</code>.',
    props:
      [
        {
          name: 'type',
          type: 'typeof Parent',
          description: 'Optional type annotation of the parent object for autocomplete and type checking.'
        }
      ]
  }
---
