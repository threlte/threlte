...
the prop, you need to create a `ClassParser` which accepts a single string and returns `NodeProps`. Let's assume, you want to create a
flex container with the following configuration:
