      ...
      [
        {
          ...
          description: 'A single number sets the pixel ratio explicitly. A tuple `[min, max]` clamps `window.devicePixelRatio` between those bounds.'
        },
        {
          name: 'toneMapping',
          type:
        ...
        { name: 'shadows', type: 'boolean | THREE.ShadowMapType', default: 'THREE.PCFShadowMap' },
        {
          name: 'createRenderer',
