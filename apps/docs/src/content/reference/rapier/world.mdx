...
componentSignature:
  {
    props:
      [
        ...
        { name: 'simulationStageOptions', type: '{ before?: (Key | Stage) | (Key | Stage)[]; after?: (Key | Stage) | (Key | Stage)[] }' },
        { name: 'synchronizationStageOptions', type: '{ before?: (Key | Stage) | (Key | Stage)[]; after?: (Key | Stage) | (Key | Stage)[] }' },
