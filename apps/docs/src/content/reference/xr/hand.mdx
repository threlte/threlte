...
<Tip type="warning">
  ...
  app, you should download and provide any anticipated models. If you want to override the default factory behavior, you can provide your own XRHandModelFactory or XRControllerModelFactory to XR.svelte:
