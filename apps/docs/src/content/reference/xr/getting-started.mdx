...
The `<XR>`, `<Controllers>`, and `<Hands>` components can provide a powerful foundation when composed with other Threlte components.

For example, it doesn't take much more to get to the point of a primitive BeatSaber-inspired experience:
