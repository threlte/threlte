...
componentSignature:
  {
    ...
    props:
      [
        ...
        { name: 'count', type: 'number', default: '5000', description: 'Number of stars' },
        { name: 'factor', type: 'number', default: '6', description: 'Size of stars' },
        { name: 'saturation', type: 'number', default: '1.0' },
        { name: 'lightness', type: 'number', default: '0.8' },
        {
          name: 'fade',
          type: 'boolean',
          default: 'true',
        ...
        { name: 'speed', type: 'number', default: '0', description: 'Speed of blinking animation' },
