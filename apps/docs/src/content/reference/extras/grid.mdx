...
componentSignature:
  {
    ...
    props:
      [
        { name: 'plane', type: "'xz' | 'xy' | 'zy'", default: "'xz'" },
        { name: 'cellColor', type: 'ColorRepresentation', default: "'#000000'" },
        { name: 'cellSize', type: 'number', default: '1' },
        { name: 'cellThickness', type: 'number', default: '1' },
        { name: 'sectionColor', type: 'ColorRepresentation', default: "'#0000ee'" },
        { name: 'sectionSize', type: 'number', default: '10' },
        { name: 'sectionThickness', type: 'number', default: '2' },
        { name: 'gridSize', type: 'number | [number, number]', default: '[20, 20]' },
        { name: 'followCamera', type: 'boolean', default: 'false' },
        { name: 'infiniteGrid', type: 'boolean', default: 'false' },
        { name: 'fadeDistance', type: 'number', default: '100' },
        { name: 'fadeStrength', type: 'number', default: '1' },
        {
          name: 'fadeOrigin',
        ...
        { name: 'type', type: "'grid' | 'lines' | 'circular' | 'polar'", default: "'grid'" },
        {
          name: 'axis',
          type: "'x' | 'y' | 'z'",
          default: "'x'",
        ...
        },
        {
          ...
          type: 'number',
          default: '0',
          description: "'circular' and 'polar' only. Maximum radius in world units. 0 removes the constraint."
        },
        {
          name: 'cellDividers',
          type: 'number',
...
<Tabs>
  ...
  <Tab name="WebGPU">
    <Example path="extras/grid-webgpu" />
  </Tab>
</Tabs>
