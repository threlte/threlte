...
A default animation will be created if your spritesheet has more than 1 totalFrames (or columns).
...
and end frames must be passed to run the desired animation within the sheet.
