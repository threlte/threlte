...
componentSignature:
  {
    ...
    props:
      [
        ...
        {
          default: 'auto',
          description: "outer radius of the gradient. if set to 'auto', becomes the radius of the circle that inscribes the canvas",
          name: 'outerRadius',
          required: false,
