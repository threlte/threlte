...
componentSignature:
  {
    ...
    props:
      [
        ...
        { name: 'ior', type: 'number', default: '2.4', description: 'Refraction index' },
        { name: 'fresnel', type: 'number', default: '0.0', description: 'Fresnel (strip light)' },
        {
        ...
        { name: 'color', type: 'ColorRepresentation', default: 'white' },
        {
          name: 'fastChrome',
          type: 'boolean',
          default: 'true',
...
{#await env.current then texture}
  <T.Mesh>
