---
{
  ...
  'componentSignature':
    {
      extends: { type: 'BufferGeometry', url: 'https://threejs.org/docs/index.html#api/en/core/BufferGeometry' },
      'props':
        [
...
```svelte title="Text3DGeometry.svelte"
<script lang="ts">
...
<T.Mesh>
	<Text3DGeometry font={'path-to-your-font'} text={'Hello'} />
...
{#await $font then loadedFont}
	<T.Mesh>
		<Text3DGeometry font={loadedFont} text={'Hello'} />
		<T.MeshStandardMaterial />
	</T.Mesh>
{/await}
```
