...
[sprites](https://en.wikipedia.org/wiki/Sprite_(computer_graphics)) in your scene. It supports the
open SpritesheetMetadata format, but we offer a convenience `buildSpritesheet` utility to easily build your spritesheet.
