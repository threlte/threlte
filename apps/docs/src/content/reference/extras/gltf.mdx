...
To use DRACO compression, provide an instance of a `DRACOLoader`.
To use KTX2 compressed textures, provide an instance of a `KTX2Loader`.

```svelte
<script>
  import { GLTF, useDraco, useKtx } from '@threlte/extras'
</script>
