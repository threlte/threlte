...
To have multiplies of the same model or to customise parts of your model (i.e. casting shadows), use the [gltf package](docs/reference/gltf/getting-started), or create your own component using the [`useGltf`](/docs/reference/extras/use-gltf) hook.
