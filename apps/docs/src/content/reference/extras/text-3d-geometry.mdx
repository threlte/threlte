...
componentSignature:
  {
    'props':
      [
        ...
        { name: 'curveSegments', type: 'number', default: '12' },
        { name: 'bevelEnabled', type: 'boolean', default: 'false' },
        { name: 'bevelThickness', type: 'number', default: '10' },
        { name: 'bevelSize', type: 'number', default: '8' },
        { name: 'bevelOffset', type: 'number', default: '0' },
        { name: 'bevelSegments', type: 'number', default: '3' },
        {
          name: 'smooth',
          type: 'number',
          default: '0',
        ...
        { name: 'extrudePath', type: 'Curve<Vector3>' },
        { name: 'steps', type: 'number', default: '1' },
        { name: 'UVGenerator', type: 'UVGenerator' }
      ]
  }
---
