...
componentSignature:
  {
    ...
    props:
      [
        { name: 'transform', type: 'boolean', default: 'false' },
        { name: 'calculatePosition', type: '(
            obj: Object3D,
            camera: Camera,
            size: { width: number; height: number }
            ) => [number, number]' },
        { name: 'eps', type: 'number', default: '0.001' },
        { name: 'occlude', type: "boolean | THREE.Object3D[] | 'blending'", default: 'false' },
        { name: 'zIndexRange', type: '[number, number]', default: '[16777271, 0]' },
        { name: 'sprite', type: 'boolean', default: 'false' },
        {
          name: 'pointerEvents',
        ...
        { name: 'distanceFactor', type: 'number', default: 'undefined' },
        { name: 'as', type: 'keyof HTMLElementTagNameMap', default: "'div'" },
        { name: 'portal', type: 'HTMLElement', default: 'undefined' },
        { name: 'castShadow', type: 'boolean', default: 'undefined' },
        { name: 'receiveShadow', type: 'boolean', default: 'undefined' },
        { name: 'material', type: 'THREE.Material', default: 'undefined' },
        { name: 'geometry', type: 'THREE.BufferGeometry', default: 'undefined' },
        {
          name: 'autoRender',
          type: 'boolean',
          default: 'true',
...
<Tabs>
  ...
  <Tab name="WebGPU">
    <Example path="extras/html/phone-webgpu" />
  </Tab>
</Tabs>
