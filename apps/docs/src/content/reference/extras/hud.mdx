...
<Tip type="warning">
  The HUD reuses the renderer, the render mode, the task scheduler, and the [default stages](/docs/learn/basics/scheduling-tasks#default-stages) of the main Threlte context.
</Tip>
