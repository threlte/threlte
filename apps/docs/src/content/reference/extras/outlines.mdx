...
componentSignature:
  {
    'props':
      [
        ...
        { name: 'opacity', type: 'boolean', default: '1', description: 'Outline transparency' },
        { name: 'thickness', type: 'number', default: '0.05', description: 'Outline thickness' },
        { name: 'toneMapped', type: 'boolean', default: 'true' },
        { name: 'angle', type: 'number', default: 'Math.PI' },
        { name: 'polygonOffset', type: 'boolean', default: 'false' },
        { name: 'polygonOffsetFactor', type: 'number', default: '0' },
        { name: 'renderOrder', type: 'number', default: '0' }
      ]
  }
---
