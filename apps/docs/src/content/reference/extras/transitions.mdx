...
<Tip type="experimental" title="Experimental">
	The plugin `transitions` uses Svelte internals. Changes to the runtime
	of Svelte may break this plugin. If you encounter any issues, please [open an issue on
	GitHub](https://github.com/threlte/threlte/issues). It's recommended to lock the
	version of Svelte to a specific version.
</Tip>
...
<Example path="extras/transitions" showFile="Scene.svelte" />
