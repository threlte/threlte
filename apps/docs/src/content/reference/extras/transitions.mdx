...
<Tip
  ...
  title="Experimental"
>
  The plugin `transitions` uses Svelte internals. Changes to the runtime of Svelte has resulted in [broken functionality](https://github.com/threlte/threlte/issues/1672) in recent version of Svelte. If you encounter additional issues, please [open an issue on
