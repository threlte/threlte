...
componentSignature:
  {
    props:
      [
        ...
        { name: 'camera', type: 'THREE.Camera | undefined' },
        { name: 'configure', type: '(csm: CSM) => void' },
        { name: 'args', type: 'CSMParameters' },
        { name: 'lightIntensity', type: 'number' },
        { name: 'lightColor', type: 'THREE.ColorRepresentation' },
        { name: 'lightDirection', type: 'THREE.Vector3Tuple', default: '[1, -1, 1]' }
      ]
  }
---
