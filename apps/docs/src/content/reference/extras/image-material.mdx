...
'componentSignature':
  {
    ...
    'props':
      [
        { name: 'color', type: 'THREE.ColorRepresentation', default: 'white' },
        ...
        { name: 'alphaThreshold', type: 'number', default: '0', description: '' },
        { name: 'alphaSmoothing', type: 'number', default: '0', description: '' },
        ...
        { name: 'side', type: 'THREE.Side', default: 'THREE.FrontSide' }
      ]
  }
---
