  ...
  componentSignature:
    {
      props:
        [
          ...
          },
          {
            ...
            required: false,
            default: 'true',
            description: 'Controls whether or not the animation is running.'
          },
          {
            name: 'filter',
            type: '"nearest" | "linear"',
      ...
      bindings:
        [
          { name: play, type: '(delay?: number) => void' },
...
Animation names [created in tags](https://www.aseprite.org/docs/tags) can be used to transition to specific animations in the spritesheet.
