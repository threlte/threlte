...
componentSignature:
  {
    props:
      [
        { name: 'opacity', type: 'number', description: 'Shadow opacity. Defaults to parent material opacity.' },
        { name: 'alphaMap', type: 'THREE.Texture | false', description: 'Alpha map for the shadow. Defaults to parent material alphaMap. Pass false to disable.' }
      ]
  }
---
...
<Tip type="info">
  This component is a workaround for a [long-standing Three.js limitation](https://github.com/mrdoob/three.js/issues/10600). It will be deprecated when Three.js adds native support for shadows from transparent objects.
</Tip>
