      ...
      [
        {
          ...
          type: 'string | Texture',
          required: false,
          description: 'Can be used instead of a material override'
        },
        {
          name: 'position',
          type: 'Vector3Tuple',
...
A declarative component for Three's [DecalGeometry](https://threejs.org/docs/#examples/en/geometries/DecalGeometry).
