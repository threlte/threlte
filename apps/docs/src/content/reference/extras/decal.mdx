...
componentSignature:
  {
    ...
    'props':
      [
        ...
        { name: 'scale', type: 'Vector3Tuple' },
        { name: 'polygonOffsetFactor', type: 'number', default: '-10' },
        { name: 'depthTest', type: 'boolean', default: 'true' },
        { name: 'mesh', type: 'Mesh', description: 'An optional parent mesh to project the decal' }
      ]
  }
---
