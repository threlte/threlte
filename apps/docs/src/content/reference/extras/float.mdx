...
componentSignature:
  {
    ...
    props:
      [
        { name: 'speed', type: 'number | [x: number, y: number, z: number]', default: '1' },
        {
          name: 'floatIntensity',
        ...
        { name: 'rotationSpeed', type: 'number | [x: number, y: number, z: number]', default: '0' },
        { name: 'seed', type: 'number', default: 'Math.random() * 10000' }
      ]
  }
---
