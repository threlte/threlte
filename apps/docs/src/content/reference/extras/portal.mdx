...
A component that renders its children as children of an object **anywhere in your Threlte application**.
Use the `id` prop to render the portal into a `<PortalTarget>` of the corresponding id.
