...
This upgrade provides better average performance, smaller bundle sizeThere are a breaking changes that were necessary for this upgrade.
...
You can find a more in-depth example [here](/docs/examples/renderers/webgpurenderer).
...
The transitions plugin currently does not work. [@TODO]
...
[scheduler stages](/docs/learn/basics/scheduling-tasks#stages). So in the most simple physics implementation:
