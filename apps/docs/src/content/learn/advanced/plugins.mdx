...
Another good example is our [bvh plugin](/docs/reference/extras/bvh) that implements [BVH raycasting](https://github.com/gkjohnson/three-mesh-bvh) on all child meshes and geometries.
