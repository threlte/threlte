...
Threlte's [bvh plugin](/docs/reference/extras/bvh) replaces three's default raycasting with a [bounding-volume heirachy](https://github.com/gkjohnson/three-mesh-bvh) implementation.
