...
<Tip type="note">
  WebGPU is still an experimental browser api and at the time of writing has [limited availability across major browsers](https://caniuse.com/?search=webgpu). For this reason, Three.js's webgpu renderer
