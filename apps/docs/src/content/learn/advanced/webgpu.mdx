...
<Tip type="tip">
  ...
  bundle size becomes an issue or you need to ship to production. If you choose option #1 you also
  don't need to be sure to use correct lights in your application.
</Tip>
