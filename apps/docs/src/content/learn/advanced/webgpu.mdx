...
Libraries such as [three-custom-shader-material](https://www.npmjs.com/package/three-custom-shader-material)
...
is updated in a `useTask` callback whereas `uIntensity` is modified in an `$effect`.
