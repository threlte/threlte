...
frame. These functions are called **tasks**. Tasks are grouped into **stages**
and may follow a specific order. Stages may be executed in a specific order as
well. Everything is managed by the **scheduler**. In this section, we will learn
how to use the scheduler, what stages are and how to create them and how to use
tasks to run code on every frame.
