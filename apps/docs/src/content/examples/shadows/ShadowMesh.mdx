...
[ShadowMesh](https://github.com/mrdoob/three.js/blob/master/examples/jsm/objects/ShadowMesh.js) is a Three.js addon that is used as very performant alternative to shadow mapping. It uses the renderer's stencil buffer and a locally computed matrix.
