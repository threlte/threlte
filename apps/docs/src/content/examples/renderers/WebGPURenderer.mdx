...
In other browsers, it will fallback to a WebGL Renderer, although performance will be signficantly degraded since this example takes
advantage of WebGPU-only optimizations.
