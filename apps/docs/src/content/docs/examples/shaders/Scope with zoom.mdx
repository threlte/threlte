...
from [useFBO](/reference/extras/misc/use-fbo) hook is used in the scope where a
...
The [useFBO](/reference/extras/misc/use-fbo) hook is used to prepare a render target for the scope's view texture.
