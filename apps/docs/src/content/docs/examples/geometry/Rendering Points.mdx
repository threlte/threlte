    ...
    <T.BufferAttribute
      ...
      attach={({ parent, ref }) => {
        ...
        return () => {
          ...
          // https://threlte.xyz/reference/core/t#attach
        }
      }}
    />
  </T.BufferGeometry>
...
won't be associated with the geometry. [Learn more about how attach works.](/reference/core/t#attach)
