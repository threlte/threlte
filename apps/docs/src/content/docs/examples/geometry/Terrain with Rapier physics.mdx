...
1. Similar to the [3D noise example](/examples/geometry/terrain), loop over the vertices of a PlaneGeometry, and use a noise map to create a heightfield array `heights`.
