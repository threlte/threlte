...
1. Similar to the [3D noise example](/examples/geometry/terrain-with-3d-noise), loop over the vertices of a PlaneGeometry, and use a noise map to create a heightfield array `heights`.
