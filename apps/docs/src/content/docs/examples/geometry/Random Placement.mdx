...
:::note
An important parameter to play with when generating scenes with this last approach is the _window
size_. It is inferred from the difference between the largest and smallest radius given. You'll
