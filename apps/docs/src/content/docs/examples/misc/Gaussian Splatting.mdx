...
<Tip type="experimental">
  ...
  not part of the [`@threlte/extras`](/reference/extras/getting-started) package *as of now*. You
  may however copy and paste them into your project and use them as you wish.
</Tip>
