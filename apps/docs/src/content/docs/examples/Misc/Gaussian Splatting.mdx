...
not part of the [`@threlte/extras`](/docs/reference/extras/getting-started) package _as of now_.
You may however copy and paste them into your project and use them as you wish.
:::

<Example path="misc/gaussian-splatting" showFile="Scene.svelte" expandCode />
