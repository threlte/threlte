...
This example demonstrates [`<InstancedSprites>`](/reference/extras/instanced-sprite), showing
...
For detailed information on defining animations and using frame ranges, refer to the [Spritesheet builder section](/reference/extras/instanced-sprite#spritesheetmetadata)
...
The example in `TreeSpriteAtlas.svelte` demonstrates the setup of static sprites, as outlined in [Static sprites & Atlassing](/reference/extras/instanced-sprite#static-sprites--atlassing).
