...
<Example path="tutorials/animating-a-spaceship" />
...
Threlte 7 improved the task scheduling API by introducing [useTask](/reference/core/hooks/use-task),
...
The equivalent Threlte 7 logic adds a task to [Threlte's default `renderStage`](/learn/basics/scheduling-tasks#default-stages)
