...
- **Fixed joint**
  - [`useFixedJoint` hook](/reference/rapier/use-fixed-joint)
...
- **Revolute joint**
  - [`useRevoluteJoint` hook](/reference/rapier/use-revolute-joint)
...
- **Prismatic joint**
  - [`usePrismaticJoint` hook](/reference/rapier/use-prismatic-joint)
...
- **Spherical joint**
  - [`useSphericalJoint` hook](/reference/rapier/use-spherical-joint)
