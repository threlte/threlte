...
<Tip type="tip">
  ...
  shortcut hook (like ['useRevoluteJoint'](/reference/rapier/use-revolute-joint)) to initialize a
  joint. This hook is used internally to initialize the currently available joints.
</Tip>
