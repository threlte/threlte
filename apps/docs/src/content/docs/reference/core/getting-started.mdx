...
Every Threlte application must be wrapped in a [`<Canvas>` component](/reference/core/canvas). This component is responsible
...
The main building block of a Threlte application is the [`<T>` component](/reference/core/t). Use this component to instantiate
