...
Every Threlte application must be wrapped in a [`<Canvas>` component](/reference/core/components/canvas). This component is responsible
...
The main building block of a Threlte application is the [`<T>` component](/reference/core/components/t). Use this component to instantiate
