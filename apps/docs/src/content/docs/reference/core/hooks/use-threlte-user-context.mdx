...
In fact, the components [`<OrbitControls>`](/reference/extras/orbit-controls) and
[`<TransformControls>`](/reference/extras/transform-controls) from `'@threlte/extras'` use this method
