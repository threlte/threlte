...
Plugins are one of Threlte's superpowers. Plugins allow you to globally extend Threlte's [`<T>`](/reference/core/t) component
...
a plugin can do, see the [interactivity plugin of `@threlte/extras`](/reference/extras/interactivity).
