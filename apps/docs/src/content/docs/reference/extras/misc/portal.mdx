...
In this case, the portal target is easily accessible, and passing the `scene` object to the `<T>` component's [attach](http://localhost:4321/docs/reference/core/components/t#attach) property can accomplish everything we need.
