...
Use the component [`<GLTF>`](/reference/extras/gltf) if you want to use a model in its entirety.
...
On the [loading-assets](/learn/basics/loading-assets) page, Threlte provides the
