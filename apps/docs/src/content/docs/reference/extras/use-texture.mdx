...
[`useLoader`](/reference/core/hooks#useloader) that returns an
[`AsyncWritable`](/reference/core/utilities#asyncwritable) store populated
...
The [`AsyncWritable`](/reference/core/utilities#asyncwritable) returned
