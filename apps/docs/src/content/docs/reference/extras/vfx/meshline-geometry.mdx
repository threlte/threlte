...
Used in combination with [`<MeshLineMaterial>`](/reference/extras/vfx/meshline-material) to create a line formed of a strip of billboarded triangles, based on <a href="https://github.com/spite/THREE.MeshLine" target="_blank">THREE.MeshLine</a>.
