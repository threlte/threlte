...
You can find an example of a [more complex scene here](/examples/animation/complex-sprite-scene).
...
[`buildSpritesheet()`](/reference/extras/performance/instanced-sprite#buildspritesheet) utility for this purpose, you are also free to implement your own
...
`flipX`, `flipY`, `frameId`. Read more about them in the [InstancedSpriteMesh](/reference/extras/performance/instanced-mesh) section
...
![Tree sprite atlas](/images/extras/instanced-sprite/useInstancedSpriteAutocomplete.png)
