...
[`buildSpritesheet()`](/reference/extras/instanced-sprite#buildspritesheet) utility for this purpose, you are also free to implement your own
...
`flipX`, `flipY`, `frameId`. Read more about them in the [InstancedSpriteMesh](/reference/extras/instanced-mesh) section
