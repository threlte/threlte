...
[extendable](/reference/studio/authoring-extensions), so you can create your own custom
...
To get started, encapsulate your whole scene in the [`<Studio>`](/reference/studio/studio) component.
