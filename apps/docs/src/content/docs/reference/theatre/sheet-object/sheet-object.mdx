...
quick and easy prop declaration. Meanwhile, [manual props APIs](/reference/theatre/sheet-object#manual-props) allow full customization of prop declaration. Many of these are offered through [slot props](https://svelte.dev/docs/special-elements#slot-slot-key-value).

<Example path="theatre/sheet-object" />

## Auto Props

The [`<Sync>`](/reference/theatre/sync) component automatically infers and synchronizes props of its parent component. Meanwhile the [`<Transform>`](/reference/theatre/transform) component creates position and rotation props for its
...
You can also use the [`<Declare>`](/reference/theatre/declare) prop slot component to colocate your manual declaration with other code.
