...
Use the component `<Transform>` from the [`<SheetObject>`](/reference/theatre/sheet-object) slot props to add the transform properties of an object to the sheet object.
