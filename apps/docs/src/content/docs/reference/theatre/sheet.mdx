...
The animated objects can adjusted in the [`<Studio>`](/reference/theatre/studio) component.
...
You can create a sheet by placing the component `<Sheet>` as a child of a [`<Project>`](/reference/theatre/project) component. If a sheet with the given name already exists, it will represent the existing sheet instead of creating a new one.
