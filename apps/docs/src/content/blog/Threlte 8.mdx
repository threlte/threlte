...
The universal [`<T>` component](/reference/core/t) has been **reduced in
...
[`<AsciiRenderer>`](/reference/extras/ascii-renderer),
[`<CubeCamera>`](/reference/extras/cube-camera),
[`<MeshDiscardMaterial>`](/reference/extras/discard-material),
[`<RadialGradientTexture>`](/reference/extras/radial-gradient-texture),
[`<LinearGradientTexture>`](/reference/extras/linear-gradient-texture),
[`useViewport`](/reference/extras/use-viewport),
[`<HUD>`](/reference/extras/hud),
[`<Resize>`](/reference/extras/resize),
[`<meshBounds>`](/reference/extras/mesh-bounds),
[`<Detailed>`](/reference/extras/detailed) and
[`<View>`](/reference/extras/view).

### Custom type support for `<T>`

Plugins such as
[`interactivity`](/reference/extras/interactivity#prop-types) now expose
...
physics](/reference/rapier/framerate) letting you craft simulations with
