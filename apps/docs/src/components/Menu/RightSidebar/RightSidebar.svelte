...
{#if headings.length}
  <div
    class="scrollbar-hide relative h-full w-full overflow-auto px-6 pb-12 lg:px-0 lg:pl-6 lg:text-sm"
  >
    <span
      class="ml-[calc(1rem+2px)] mb-3 block px-0 py-0 pt-6 text-xs text-white/80 lg:relative lg:top-0 lg:w-full lg:text-sm lg:font-bold lg:text-white"
      >On this page</span
    >
