        ...
        >
          <TheatreTextBox key="warp">
            <div class="flex flex-col items-center justify-center gap-0"> 
              ...
              <h1 class="text-center text-5xl font-bold mt-5 ml-8" style="letter-spacing: 0.8em;">THRELTE</h1>
              <svg
              ...
              <h1 class="text-center text-5xl font-bold ml-8" style="letter-spacing: 0.8em;">2023</h1>
            </div>
          </TheatreTextBox>
