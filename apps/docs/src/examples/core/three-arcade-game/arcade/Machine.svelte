<script lang="ts">
  ...
  const [gltf, scanLinesTexture] = await Promise.all([
    useGltf<GLTFResult>('/models/ball-game/archade-machine/arcade_machine_own.glb').then((gltf) => {
    ...
    useTexture('/models/ball-game/archade-machine/textures/scanlines.png')
  ])
