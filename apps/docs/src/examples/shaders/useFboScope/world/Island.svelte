...
<script lang="ts">
  ...
  interface Props_1 extends Props<THREE.Group> {
    [key: string]: any
  }

  let { ref = $bindable(), ...rest }: Props_1 = $props()
  ...
  const gltf = await useGltf<GLTFResult>('/models/issum_the_town_on_capital_isle-transformed.glb', {
    dracoLoader
  })
</script>
