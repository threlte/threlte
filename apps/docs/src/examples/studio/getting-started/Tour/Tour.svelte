...
<Portal target="#tour-target">
  <div class="contents">
    ...
    {:else}
      <!-- INSTRUCTIONS -->
      <div
        class="pointer-events-none absolute z-[10000] flex w-full select-none items-center justify-center ${instructionsPlacement === 'bottom' || !instructionsPlacement ? 'bottom-2': 'top-1/2 -translate-y-1/2'}"
      >
        {#if tourManager.instructionsManager.currentInstructions}
          <div
