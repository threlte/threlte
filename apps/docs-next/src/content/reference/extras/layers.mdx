...
name: 'layers'
sourcePath: 'extras/src/lib/layers'
type: 'plugin'
---
...
<Tip type="tip">
  This plugin injects and relies on a context. Check out the [guide on structuring your
  app](/docs/learn/basics/context#recommended-app-structure) to learn more about contexts.
</Tip>
