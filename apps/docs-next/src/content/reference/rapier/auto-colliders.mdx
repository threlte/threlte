  ...
  componentSignature:
    {
      ...
      props:
        [
          ...
          { name: 'position', required: false, type: 'Position' },
          { name: 'scale', required: false, type: 'Scale' },
          { name: 'rotation', required: false, type: 'Rotation' },
          { name: 'lookAt', required: false, type: 'LookAt' },
