...
componentSignature:
  {
    props:
      [
        {name: 'name', type: 'string', default: 'default', required: true},
        ...
        {name: 'snap', type: 'object', required: false},
      ]
  }
---

A component `<Editable>` represents a set of editable and animatable properties of its parent. This component is creating a Theatre.js sheet object under the hood and therefore all original concepts apply.

#### Theatre.js Docs

|&nbsp;|&nbsp;|&nbsp;|
|---|---|---|
| **Sheet Object** | [Sheet Object Manual](https://www.theatrejs.com/docs/latest/manual/objects)  | [Sheet Object API Reference](https://www.theatrejs.com/docs/0.5/api/core#object)  |

<Example path="theatre/editable" iframe/>
