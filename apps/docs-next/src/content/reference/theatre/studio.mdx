...
|&nbsp;|&nbsp;|&nbsp;|&nbsp;|
|---|---|---|---|
| **Studio** | [Studio Manual](https://www.theatrejs.com/docs/0.5/manual/Studio)  | [Studio keyboard Shortcuts](https://www.theatrejs.com/docs/0.5/manual/keyboard-shortcuts) | [Studio API Reference](https://www.theatrejs.com/docs/0.5/api/studio)  |
