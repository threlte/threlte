...
| [\<Sheet\>](./sheet)              | Binds to an animation _sequence_ and contains the animated components   | [Sheet](https://www.theatrejs.com/docs/0.5/manual/sheets), [Sequence](https://www.theatrejs.com/docs/0.5/manual/sequences)                                                           |
| [\<Studio\>](./project)           | Enables the Theatre.js in-browser studio _interface_ during development | [Studio](https://www.theatrejs.com/docs/0.5/manual/Studio)                                                                                                                           |
| [\<SheetObject\>](./sheet-object) | Enables editing and animating its parent in the studio interface        | [Sheet Object](https://www.theatrejs.com/docs/0.5/manual/objects)                                                                                                                    |
