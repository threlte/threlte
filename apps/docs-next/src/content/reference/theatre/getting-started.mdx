...
| [\<Sheet\>](./sheet)              | Binds to an animation _sequence_ and contains the animated components   | [Sheet](https://www.theatrejs.com/docs/latest/manual/sheets), [Sequence](https://www.theatrejs.com/docs/latest/manual/sequences)                                                           |
| [\<Studio\>](./project)           | Enables the Theatre.js in-browser studio _interface_ during development | [Studio](https://www.theatrejs.com/docs/latest/manual/Studio)                                                                                                                           |
