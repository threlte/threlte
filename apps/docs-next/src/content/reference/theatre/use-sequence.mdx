...
The hook can be used within the [`<Sheet>`](/docs/reference/theatre/sheet) context or withing the [`<Seqence>`](/docs/reference/theatre/sequence) context:
...
<Example path="theatre/use-sequence" iframe/>
