        ...
        [
          {
            ...
            description: 'Called as an XRSession is requested.'
          },
          {
            name: 'sessionend',
            payload: 'THREE.Event & { target: XRSession }',
            description: 'Called after an XRSession is terminated.'
          },
          {
            name: 'visibilitychange',
            payload: 'THREE.Event & { target: XRSession }',
            description: 'Called when an XRSession is hidden or unfocused.'
          },
          {
            name: 'inputsourceschange',
            payload: 'THREE.Event & { target: XRSession }',
            description: 'Called when available inputsources change.'
          }
        ],
    }
}
