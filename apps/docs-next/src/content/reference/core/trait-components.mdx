...
<Tip type="warning">
  **Trait components** are used mostly internally and make certain aspects of three.js objects
  accessible and reactive and interactable with Threlte systems. It's an advanced feature and you
  should only use it if you know what you're doing.
</Tip>
