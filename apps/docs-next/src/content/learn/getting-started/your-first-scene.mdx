...
We're still staring at the side of a cube, let's add a camera and look from at at an angle:
...
plugin [`interactivity`](/docs/reference/extras/interactivity) from
