...
See [`useThrelte`](/docs/hooks/01-use-threlte), [`useThrelteRoot`](/docs/hooks/02-use-threlte-root) and [`useThrelteAudio`](/docs/hooks/03-use-threlte-audio) on how to easily consume these from within child components of `<Canvas>`.
